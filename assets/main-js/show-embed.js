document.addEventListener("DOMContentLoaded", () => {
  ...
  const COMPLETE_PDF = `/assets/pdf/files/${sectionKey}-section.pdf`;
  const FULL_PDF = `/assets/pdf/files/${webpageKey}-webpage.pdf`;
  const SIMPLE_PDF = `/assets/pdf/files/${webpageKey}-simple.pdf`;
