...
` +
    ...
    var Kn = En(
      ...
      Yn = En(m({}, Dn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      Xn = En(
        m({}, Pn, {
          deltaX: function (e) {
            return `deltaX` in e
      ...
      Zn = En(m({}, Dn, { newState: 0, oldState: 0 })),
      Qn = [9, 13, 27, 32],
...
`,
  ...
  te = (e, t) => {
    ...
    if (x) for (var n of x(t)) S.call(t, n) && C(e, n, t[n]);
    return e;
  },
  ne = (e, t) => {
    var n = {};
    for (var r in e) ee.call(e, r) && t.indexOf(r) < 0 && (n[r] = e[r]);
    if (e != null && x)
      for (var r of x(e)) t.indexOf(r) < 0 && S.call(e, r) && (n[r] = e[r]);
    return n;
  },
  re;
(((e) => {
  let t = class t {
    ...
    static encodeSegments(e, r, a = 1, s = 40, c = -1, l = !0) {
      if (
        !(t.MIN_VERSION <= a && a <= s && s <= t.MAX_VERSION) ||
        c < -1 ||
        c > 7
      )
      ...
      let f = [];
      for (let t of e) {
        (n(t.mode.modeBits, 4, f),
          n(t.numChars, t.mode.numCharCountBits(u), f));
    ...
    drawFormatBits(e) {
      ...
      for (let e = 0; e < 8; e++)
        this.setFunctionModule(this.size - 1 - e, 8, r(a, e));
      for (let e = 8; e < 15; e++)
        this.setFunctionModule(8, this.size - 15 + e, r(a, e));
      ...
      if (this.version == 1) return [];
      {
        let e = Math.floor(this.version / 7) + 2,
          t =
            this.version == 32
              ? 26
              : Math.ceil((this.version * 4 + 4) / (e * 2 - 2)) * 2,
          n = [6];
...
function me(e, t, n, r) {
  ...
  let i = e.length + n * 2,
    ...
    s = (r.width || a) * o,
    c = (r.height || a) * o,
    l = r.x == null ? e.length / 2 - s / 2 : r.x * o,
    u = r.y == null ? e.length / 2 - c / 2 : r.y * o,
    d = r.opacity == null ? 1 : r.opacity,
    f = null;
  if (r.excavate) {
    let e = Math.floor(l),
      t = Math.floor(u);
    f = { x: e, y: t, w: Math.ceil(s + l - e), h: Math.ceil(c + u - t) };
  }
  let p = r.crossOrigin;
  return { x: l, y: u, h: c, w: s, excavation: f, opacity: d, crossOrigin: p };
}
function he(e, t) {
  return t == null ? (e ? T : E) : Math.max(Math.floor(t), 0);
}
function D({
  value: e,
  level: t,
  ...
  let c = v.useMemo(() => {
      let r = (Array.isArray(e) ? e : [e]).reduce(
        (e, t) => (e.push(...w.QrSegment.makeSegments(t)), e),
        [],
      );
      return w.QrCode.encodeSegments(r, ie[t], n, void 0, void 0, s);
    }, [e, t, n, s]),
    {
      cells: l,
      margin: u,
      ...
      return {
        ...
        calculatedImageSettings: me(e, o, t, a),
      };
    }, [c, o, a, r, i]);
  return {
    qrcode: c,
      ...
      if (_.current != null) {
        ...
        let n = C,
          ...
          a =
            ...
            r.naturalHeight !== 0 &&
            r.naturalWidth !== 0;
        a && w.excavation != null && (n = pe(C, w.excavation));
        let c = window.devicePixelRatio || 1;
        e.height = e.width = i * c;
        let l = (i / re) * c;
        (t.scale(l, l),
          (t.fillStyle = o),
          t.fillRect(0, 0, re, re),
          (t.fillStyle = s),
          ge
            ? t.fill(new Path2D(fe(n, S)))
            : C.forEach(function (e, n) {
                e.forEach(function (e, r) {
                  e && t.fillRect(r + S, n + S, 1, 1);
                });
              }),
          w && (t.globalAlpha = w.opacity),
          a && t.drawImage(r, w.x + S, w.y + S, w.w, w.h));
      }
    }),
      v.useEffect(() => {
        ee(!1);
      }, [g]));
    let ie = te({ height: i, width: i }, m),
      T = null;
    return (
      g != null &&
      ...
      v.createElement(
        ...
        v.createElement(
          `canvas`,
          te({ style: ie, height: i, width: i, ref: b, role: `img` }, h),
        ),
        T,
      )
    );
  });
_e.displayName = `QRCodeCanvas`;
var ve = v.forwardRef(function (e, t) {
  let n = e,
    {
      value: r,
      size: i = ae,
  ...
  p != null &&
    y != null &&
    (y.excavation != null && (b = pe(g, y.excavation)),
    (x = v.createElement(`image`, {
      href: p.src,
      height: y.h,
      width: y.w,
      x: y.x + h,
  ...
  return v.createElement(
    `svg`,
    te(
      { height: i, width: i, viewBox: `0 0 ${_} ${_}`, ref: t, role: `img` },
      m,
    ),
    !!d && v.createElement(`title`, null, d),
    v.createElement(`path`, {
      fill: o,
      d: `M0,0 h${_}v${_}H0z`,
      shapeRendering: `crispEdges`,
    }),
    v.createElement(`path`, { fill: s, d: ee, shapeRendering: `crispEdges` }),
    x,
  );
});
ve.displayName = `QRCodeSVG`;
var ye = o((e) => {
    var t = Symbol.for(`react.transitional.element`),
  ...
  we = (e, t = 880) => {
    try {
      ...
      ((r.type = `sine`),
        (r.frequency.value = t),
        i.gain.setValueAtTime(0.8, n.currentTime),
        i.gain.exponentialRampToValueAtTime(0.001, n.currentTime + e / 1e3),
        r.connect(i),
        i.connect(n.destination),
        r.start(),
        r.stop(n.currentTime + e / 1e3));
    } catch (e) {
...
function Ee({
  ...
  return (0, O.jsxs)(`div`, {
    className: `mb-4 bg-indigo-950/40 border border-indigo-500/30 rounded-2xl p-4 flex flex-col items-center justify-center text-center shadow-lg backdrop-blur-sm`,
    children: [
      (0, O.jsx)(`div`, {
        className: `text-xs font-semibold tracking-wider text-indigo-400 uppercase mb-1`,
        children:
          e === `task`
            ? `Task pacing Loop: ${r}s`
            : `Simple Pacing Loop: ${r}s`,
      }),
      e === `task`
        ? (0, O.jsxs)(`div`, {
            className: `w-full mb-3 flex flex-col items-center gap-2`,
            children: [
              (0, O.jsxs)(`div`, {
              ...
              (0, O.jsxs)(`div`, {
                ...
                children: [
                  (0, O.jsx)(`div`, {
                    className: `text-[10px] font-bold text-emerald-300 uppercase tracking-wider`,
        ...
        : (0, O.jsx)(`div`, {
            className: `text-4xl font-mono font-bold text-white mb-3`,
            children: Te(t),
          }),
      (0, O.jsxs)(`div`, {
        ...
        children: [
          (0, O.jsx)(`button`, {
            onClick: () => a(!i),
            className: `px-4 py-1.5 rounded-xl font-bold text-xs tracking-wide uppercase transition ${i ? `bg-amber-600 hover:bg-amber-500 text-white` : `bg-emerald-600 hover:bg-emerald-500 text-white`}`,
            children: i ? `⏸ Pause` : `▶ Start`,
          }),
          (0, O.jsx)(`button`, {
            onClick: o,
            className: `bg-slate-800 hover:bg-slate-700 text-slate-300 px-3 py-1.5 rounded-xl font-bold text-xs tracking-wide uppercase transition`,
            children: `Reset`,
          }),
        ],
      }),
...
function De() {
  let [e, t] = (0, v.useState)(() => {
      let e = localStorage.getItem(`neuro_checklists`);
      return e ? JSON.parse(e) : [];
    }),
    [n, r] = (0, v.useState)(() => {
      let e = localStorage.getItem(`neuro_checklist_groups_v1`);
      return e ? JSON.parse(e) : [];
    }),
    [i, a] = (0, v.useState)(() => {
      let e = localStorage.getItem(`neuro_checklist_groups_collapsed_v1`);
      return e ? JSON.parse(e) : {};
    }),
    [o, s] = (0, v.useState)(() => {
      let e = localStorage.getItem(`neuro_checklist_location_presets_v1`);
      return e ? JSON.parse(e) : [`on me`, `on my desk`];
    }),
    [c, l] = (0, v.useState)(`checklist`),
    u = `__UNGROUPED__`,
    [d, f] = (0, v.useState)(null),
    [p, m] = (0, v.useState)(``),
    [h, g] = (0, v.useState)(`checklist`),
    [_, y] = (0, v.useState)(``),
    [b, x] = (0, v.useState)(``),
    [ee, S] = (0, v.useState)(null),
    [C, te] = (0, v.useState)(``),
    [ne, re] = (0, v.useState)(null),
    [w, ie] = (0, v.useState)(``),
    [ae, oe] = (0, v.useState)(``),
    [se, ce] = (0, v.useState)(``),
    [le, ue] = (0, v.useState)(`preset`),
    [T, E] = (0, v.useState)(``),
    [de, fe] = (0, v.useState)(``),
    pe = () => {
      let e = de.trim();
      e && (s((t) => (t.includes(e) ? t : [...t, e])), fe(``));
    },
    me = (e) => {
      s((t) => t.filter((t) => t !== e));
    },
    [he, D] = (0, v.useState)(null),
    [ge, _e] = (0, v.useState)(null),
    [ye, be] = (0, v.useState)(0),
    [xe, Se] = (0, v.useState)(60),
    [De, Oe] = (0, v.useState)(!1),
    [ke, Ae] = (0, v.useState)(``),
    [je, Me] = (0, v.useState)(``),
    [Ne, Pe] = (0, v.useState)(``),
    [Fe, Ie] = (0, v.useState)(!1),
    [Le, Re] = (0, v.useState)(null),
    [ze, Be] = (0, v.useState)(!1),
    Ve = (0, v.useRef)(null),
    He = (0, v.useRef)(null),
    Ue = (0, v.useRef)(null),
    We = (0, v.useRef)(null),
    Ge = (0, v.useRef)(null),
    Ke = e.find((e) => e.id === d),
    k = Ke ? { type: `checklist`, ...Ke } : null;
  ((0, v.useEffect)(() => {
    let e = async () => {
        try {
          `wakeLock` in navigator &&
            !He.current &&
            (He.current = await navigator.wakeLock.request(`screen`));
        } catch (e) {
          console.error(`${e.name}, ${e.message}`);
        }
      },
      t = async () => {
        He.current &&= (await He.current.release(), null);
      },
      n = async () => {
        He.current !== null &&
          ...
          (Ve.current = setInterval(() => {
            (be((e) => e + 1),
              Se((e) => {
                ...
                return (
                  t === 30 &&
                    (we(100, 880), setTimeout(() => we(100, 880), 200)),
                  t <= 0 ? (we(600, 880), 60) : t
                );
              }));
          }, 1e3)))
        : (clearInterval(Ve.current),
          t(),
    ...
    (0, v.useEffect)(() => {
      (Oe(!1), be(0), Se(60), Be(!1));
    }, [d]),
    (0, v.useEffect)(() => {
      localStorage.setItem(`neuro_checklists`, JSON.stringify(e));
    }, [e]),
    (0, v.useEffect)(() => {
      localStorage.setItem(`neuro_checklist_groups_v1`, JSON.stringify(n));
    }, [n]),
    (0, v.useEffect)(() => {
      localStorage.setItem(
        `neuro_checklist_groups_collapsed_v1`,
        JSON.stringify(i),
      );
    }, [i]),
    (0, v.useEffect)(() => {
      localStorage.setItem(
        `neuro_checklist_location_presets_v1`,
        JSON.stringify(o),
      );
    }, [o]),
    (0, v.useEffect)(() => {
      let e = new URLSearchParams(window.location.search).get(`connectId`);
      e &&
        ...
        (async () => {
          (Me(e),
            Pe(`Processing incoming scan...`),
            We.current || (await qe()),
            setTimeout(() => {
              Pe(`Connecting to desktop target...`);
              let t = We.current.connect(e.trim());
              ((Ge.current = t), Je(t));
            }, 1e3));
        })());
    }, []));
  let qe = async () => {
      Pe(`Initializing connection server...`);
      let { default: e } = await Ce(async () => {
          let { default: e } = await import(`./bundler-BQhO7P4A.js`);
          return { default: e };
        }, []),
        t = new e({
          config: {
      ...
      ((We.current = t),
        t.on(`open`, (e) => {
          (Ae(e), Pe(`Ready to connect. Share your code.`));
        }),
        t.on(`connection`, (e) => {
          ((Ge.current = e), Je(e));
        }),
        t.on(`error`, (e) => {
          (console.error(`PeerJS Error:`, e.type, e), Pe(`Error: ${e.type}`));
        }));
    },
    Je = (e) => {
      (e.on(`open`, () => {
        Pe(`Connected to peer! Ready to sync.`);
      }),
        e.on(`data`, (e) => {
          if (
            e &&
            e.type === `SYNC_DATA` &&
            window.confirm(
              `Received checklist sync from your other device. Overwrite current local data?`,
            )
          ) {
            let n = e.payload?.lists ?? [],
              i = e.payload?.groups ?? [],
              o = e.payload?.collapsedGroupIds ?? {};
            (t(n), r(i), a(o), Pe(`Sync successful! Data updated.`));
          }
        }),
        e.on(`close`, () => Pe(`Connection closed.`)),
        e.on(`error`, (e) => {
          (console.error(`Connection error:`, e),
            Pe(`Connection error occurred.`));
        }));
    },
    Ye = () => {
      if (!je.trim()) return;
      Pe(`Connecting to target...`);
      let e = We.current.connect(je.trim());
      ((Ge.current = e), Je(e));
    },
    Xe = () => {
      Ge.current && Ge.current.open
        ? (Ge.current.send({
            type: `SYNC_DATA`,
            payload: { lists: e, groups: n, collapsedGroupIds: i },
          }),
          Pe(`Data pushed successfully!`))
        : alert(`No open peer connections detected.`);
    },
    A = (n) => {
      t(e.map((e) => (e.id === d ? { ...e, ...n } : e)));
    },
    Ze = () => {
      (Oe(!1),
        be(0),
        ...
        k &&
          A({
            items: k.items.map((e) => {
              let { splitMetrics: t, ...n } = e;
              return n;
            }),
          }));
    },
    Qe = (e) => {
      A({ history: (k.history || []).filter((t) => t.id !== e) });
    },
    $e = (i) => {
      if ((i.preventDefault(), !p.trim())) return;
      if (h === `group`) {
        let e = Date.now(),
          t = p.trim();
        (r([...n, { id: e, name: t }]),
    ...
    et = (e) => {
      if ((e.preventDefault(), !_.trim() || !d)) return;
      let t =
          k.type === `inventory`
            ? { id: Date.now(), text: _.trim(), location: b.trim() }
            : { id: Date.now(), text: _.trim(), done: !1 },
        n = { items: [...(k?.items || []), t] };
      (k.type === `checklist` &&
        (k?.startTrackingItemId || (n.startTrackingItemId = t.id),
        (n.endTrackingItemId = t.id)),
        A(n),
        y(``),
        x(``));
    },
    tt = (e) => {
      if (ne === e || !k || k.type === `inventory`) return;
      let n = k.items.findIndex((t) => t.id === e),
        r = k.items.findIndex(
          (e) => String(e.id) === String(k.startTrackingItemId),
        ),
        i = String(e) === String(k.endTrackingItemId),
        a = k.items.find((t) => t.id === e);
      if (!a) return;
      let o = !a.done,
        s = k.items.map((t) => {
          if (t.id !== e) return t;
          if (
            ...
            let e = k.items
                .filter(
                  (e) =>
                    e.done && e.splitMetrics?.totalSecondsAbsolute !== void 0,
                )
                .map((e) => e.splitMetrics.totalSecondsAbsolute),
              n = ye - (e.length > 0 ? Math.max(...e) : 0);
            return {
              ...t,
              done: o,
              splitMetrics: {
                splitText: Te(n),
                totalText: Te(ye),
                totalSecondsAbsolute: ye,
              },
            };
          }
          let { splitMetrics: i, ...a } = t;
          return { ...a, done: o };
        }),
        c = k.history || [];
      if (i && o && k.historyEnabled) {
        let e = s.filter((e) => e.splitMetrics);
        e.length > 0 &&
          (c = [
            {
              id: Date.now(),
              date: new Date().toLocaleString(void 0, {
                hour: `2-digit`,
                minute: `2-digit`,
                month: `short`,
                day: `numeric`,
              ...
              splits: e.map((e) => ({
                text: e.text,
                splitText: e.splitMetrics.splitText,
                totalText: e.splitMetrics.totalText,
              })),
            },
            ...c,
          ]);
      ...
      let l = () => {
        let n = !!k.linkEnabled,
          r = (k.linkUpdatesByItemId || {})[e],
          i = (e) => {
            if (!n || !r || !o) return e;
            let t = r.targetInventoryListId,
              i = r.targetInventoryItemId,
              a = r.updateLocation;
            return t === void 0 || i === void 0 || a == null
              ? e
              : e.map((e) => {
                  if (String(e.id) !== String(t) || e.type !== `inventory`)
                    return e;
                  let n = (e.items || []).map((e) =>
        ...
        t((e) =>
          i(e).map((e) => (e.id === d ? { ...e, items: s, history: c } : e)),
        );
      };
      k.focusModeEnabled
        ? (Re(e),
          setTimeout(() => {
            (l(), Re(null), i && o && k.historyEnabled && we(200, 1100));
          }, 300))
        : l();
    },
    nt = (e, t) => {
      if ((t.stopPropagation(), re(e.id), ie(e.text), k.type === `inventory`)) {
        let t = e.location || ``;
        (oe(t),
          o.includes(t)
            ? (ue(`preset`), E(t), ce(``))
        ...
        w.trim() &&
          (A({
            items: k.items.map((t) =>
              t.id === e
                ? k.type === `inventory`
                  ? { ...t, text: w.trim(), location: ae.trim() }
                  : { ...t, text: w.trim() }
                : t,
            ),
          }),
    ...
    it = (e, t) => {
      t.stopPropagation();
      let n = k.items.filter((t) => t.id !== e),
        r = { items: n };
      (String(k.startTrackingItemId) === String(e) &&
        (r.startTrackingItemId = n[0]?.id || ``),
        String(k.endTrackingItemId) === String(e) &&
          (r.endTrackingItemId = n[n.length - 1]?.id || ``),
        A(r));
    },
    at = (e) => {
      ne !== null || k?.focusModeEnabled || _e(e);
    },
    ot = (n, r) => {
      if ((n.preventDefault(), ge === null || ge === r || k?.focusModeEnabled))
        return;
      let i = e.map((e) => {
        if (e.id === d) {
          let t = [...e.items],
            n = t.splice(ge, 1)[0];
          return (t.splice(r, 0, n), { ...e, items: t });
        }
        return e;
      });
      (_e(r), t(i));
    ...
    ct = (e, t) => {
      (t.stopPropagation(), S(e.id), te(e.name));
    },
    lt = (n, r) => {
      (r && r.stopPropagation(),
        C.trim() &&
          (t(e.map((e) => (e.id === n ? { ...e, name: C.trim() } : e))),
          S(null)));
    },
    ut = (n, r) => {
      (r.stopPropagation(),
        window.confirm(`Are you sure you want to delete this list?`) &&
          (t(e.filter((e) => e.id !== n)), d === n && f(null)));
    },
    dt = () => {
      try {
        let t = JSON.stringify(
            { lists: e, groups: n, collapsedGroupIds: i, locationPresets: o },
            null,
            2,
          ),
          r = `data:application/json;charset=utf-8,` + encodeURIComponent(t),
          a = document.createElement(`a`);
        (a.setAttribute(`href`, r),
          a.setAttribute(`download`, `blueprints_backup.json`),
          a.click());
      } catch {
        ...
        ((n.onload = (n) => {
          try {
            let e = JSON.parse(n.target.result),
              i = Array.isArray(e) ? e : e?.lists,
              o = Array.isArray(e?.groups) ? e.groups : e?.groups,
              c =
                e?.collapsedGroupIds && typeof e.collapsedGroupIds == `object`
                  ? e.collapsedGroupIds
                  : {},
              l = Array.isArray(e?.locationPresets) ? e.locationPresets : null;
            if (!Array.isArray(i)) {
              alert(`Invalid file format.`);
              return;
            }
            window.confirm(`Importing will overwrite data. Proceed?`) &&
              (t(i),
              r(Array.isArray(o) ? o : []),
              a(c || {}),
              s(Array.isArray(l) ? l : [`on me`, `on my desk`]),
              f(null));
          } catch {
    ...
    j = k?.focusModeEnabled ? k.items.find((e) => !e.done) : null,
    mt = k?.items.filter((e) => e.done).length || 0,
    ht = (k?.items.length || 0) - mt,
    gt =
      k?.type === `checklist` && k.timerEnabled && k.timerMode === `task`
        ? k.items.findIndex(
            (e) => String(e.id) === String(k.startTrackingItemId),
          )
        : -1,
    _t =
      k?.type === `checklist` && k.timerEnabled && k.timerMode === `task`
        ? k.items.findIndex((e) => String(e.id) === String(k.endTrackingItemId))
        : -1,
    vt =
      k?.type === `checklist` &&
      k.timerEnabled &&
      k.timerMode === `task` &&
      gt !== -1
        ? k.items.find((e, t) => t >= gt && (_t === -1 || t <= _t) && !e.done)
        : null,
    yt = vt ? k.items.findIndex((e) => e.id === vt.id) : -1,
    bt =
      k?.type === `checklist` &&
      k.timerEnabled &&
      k.timerMode === `task` &&
      gt !== -1
        ? (() => {
            let e = k.items
              .map((e, t) => ({ item: e, idx: t }))
              .filter(({ item: e, idx: t }) => {
                let n = t >= gt && (_t === -1 || t <= _t),
                  r = yt === -1 ? !0 : t < yt;
                return (
                  n &&
                  e.done &&
                  r &&
                  e.splitMetrics?.totalSecondsAbsolute !== void 0
                );
              })
              .map(({ item: e }) => e.splitMetrics.totalSecondsAbsolute);
    ...
    xt =
      k?.type === `checklist` && k.timerEnabled && k.timerMode === `task`
        ? Math.max(0, ye - bt)
        : 0,
    St = e.filter((e) => e.type === `inventory`),
    Ct = (e, t) => {
      A({
        linkUpdatesByItemId: {
          ...(k.linkUpdatesByItemId || {}),
          [e]: { ...(k.linkUpdatesByItemId || {})[e], ...t },
        },
      });
    },
    wt = (e) => {
      let t = { ...(k.linkUpdatesByItemId || {}) };
      (delete t[e], A({ linkUpdatesByItemId: t }));
    };
  return (0, O.jsxs)(`div`, {
    className: `min-h-screen bg-slate-900 text-slate-100 font-sans antialiased`,
    children: [
      (0, O.jsx)(`input`, {
        type: `file`,
        ref: Ue,
      ...
      (0, O.jsx)(`header`, {
        className: `border-b border-slate-800 bg-slate-900/50 backdrop-blur sticky top-0 z-10`,
        children: (0, O.jsx)(`div`, {
          className: `max-w-md mx-auto px-4 h-16 flex items-center justify-between gap-4`,
          children: d
            ? (0, O.jsxs)(`div`, {
                className: `flex items-center justify-between w-full`,
                children: [
                  (0, O.jsx)(`h1`, {
                    className: `text-lg font-bold tracking-wide text-indigo-400 truncate max-w-[70%]`,
                    children: k.name,
                  }),
                  (0, O.jsx)(`button`, {
                    onClick: () => {
                    ...
                    className: `text-sm font-medium bg-slate-800 hover:bg-slate-700 px-3 py-1.5 rounded-lg transition shrink-0`,
                    children: `← Back`,
                  }),
                ],
              })
                  ...
                  (0, O.jsxs)(`div`, {
                    ...
                    children: [
                      (0, O.jsx)(`button`, {
                        ...
                        className: `p-1.5 text-xs bg-indigo-950 text-indigo-300 border border-indigo-800 rounded-md transition`,
                        children: `🌐 P2P Sync`,
                      }),
                      (0, O.jsx)(`button`, {
                        onClick: dt,
                        className: `p-1.5 text-xs bg-slate-800 text-slate-300 rounded-md transition`,
                        children: `📤 Export`,
                      }),
                      (0, O.jsx)(`button`, {
                        onClick: ft,
      ...
      (0, O.jsxs)(`main`, {
        ...
        children: [
          Fe &&
            (0, O.jsxs)(`div`, {
              className: `mb-6 bg-slate-800 border-2 border-indigo-500 rounded-2xl p-4 shadow-xl`,
              children: [
                (0, O.jsxs)(`div`, {
                  className: `flex justify-between items-center mb-3`,
                  children: [
                    (0, O.jsx)(`h3`, {
                      className: `font-bold text-indigo-400 text-sm`,
                      children: `Device-to-Device WebRTC Sync`,
                    }),
                    (0, O.jsx)(`button`, {
                      onClick: () => Ie(!1),
                ...
                (0, O.jsx)(`p`, {
                  ...
                  children: `Directly link devices browser-to-browser to clone your configuration arrays.`,
                }),
                ke &&
                  (0, O.jsx)(`div`, {
                    className: `flex flex-col items-center justify-center p-4 mb-3 bg-white rounded-xl border border-slate-700 mx-auto w-40 h-40 shadow-inner`,
                    children: (0, O.jsx)(ve, {
                      value: `${window.location.origin}${window.location.pathname}?connectId=${ke}`,
                      size: 128,
                      bgColor: `#ffffff`,
                      fgColor: `#0f172a`,
                      level: `L`,
                ...
                (0, O.jsxs)(`div`, {
                  className: `bg-slate-950 p-2.5 rounded-xl border border-slate-800 mb-3 text-center`,
                  children: [
                    (0, O.jsx)(`span`, {
                      className: `block text-[10px] text-slate-500 font-bold uppercase tracking-wider`,
                      children: `Your Device Sync Code`,
                    }),
                    (0, O.jsx)(`span`, {
                      className: `font-mono text-xs select-all text-emerald-400 block break-all`,
                      children: ke || `Generating connection key...`,
                    }),
                  ],
                }),
                (0, O.jsxs)(`div`, {
                  ...
                  children: [
                    (0, O.jsx)(`input`, {
                      type: `text`,
                      placeholder: `Paste code or scan result`,
                      value: je,
                      onChange: (e) => Me(e.target.value),
                      className: `flex-1 bg-slate-900 text-xs border border-slate-700 rounded-xl px-3 py-2 text-slate-100`,
                    }),
                    (0, O.jsx)(`button`, {
                      onClick: Ye,
                      className: `bg-indigo-600 hover:bg-indigo-500 px-3 py-1 text-xs font-bold rounded-xl transition`,
                      children: `Connect`,
                    }),
                  ],
                }),
                (0, O.jsx)(`button`, {
                  onClick: Xe,
                  className: `w-full mt-1 bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-2 rounded-xl text-xs uppercase tracking-wider transition`,
                  children: `📦 Overwrite Connected Device`,
                }),
                (0, O.jsx)(`div`, {
                  className: `text-[11px] text-slate-400 text-center mt-2 font-mono italic`,
                  children: Ne,
                }),
              ],
            }),
          d
            ? (0, O.jsxs)(`div`, {
                children: [
                  (0, O.jsxs)(`div`, {
                    className: `mb-4 bg-slate-800/80 border border-slate-700 rounded-2xl p-4 shadow-sm`,
                    children: [
                      (0, O.jsx)(`span`, {
                        className: `text-xs font-bold text-slate-400 flex items-center gap-1.5 uppercase tracking-wider mb-3`,
                        children: `🛠️ Active Utilities Control Panel`,
                      }),
                      k.type === `inventory` &&
                        (0, O.jsxs)(`div`, {
                          ...
                          children: [
                            (0, O.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, O.jsx)(`button`, {
                                  ...
                                  className: `text-[10px] bg-slate-900 text-slate-300 px-2 py-1 rounded border border-slate-800 hover:border-slate-700 transition`,
                                  type: `button`,
                            ...
                            (0, O.jsxs)(`div`, {
                              ...
                              children: [
                                (0, O.jsx)(`input`, {
                                  type: `text`,
                                  placeholder: `Add preset location`,
                                  value: de,
                                  onChange: (e) => fe(e.target.value),
                                  className: `flex-1 bg-slate-900 border border-slate-700 rounded-lg px-2 py-1 text-xs text-slate-100`,
                                }),
                                (0, O.jsx)(`button`, {
                                  type: `button`,
                                  onClick: pe,
                                  className: `bg-indigo-600 hover:bg-indigo-500 px-3 py-1 rounded-lg text-xs font-bold text-white`,
                                  children: `Add`,
                                }),
                              ],
                            }),
                              ...
                              children: [
                                o.map((e) =>
                                  (0, O.jsxs)(
                                    `div`,
                                    {
                                      className: `flex items-center gap-2 bg-slate-900 border border-slate-800 rounded-lg px-2 py-1`,
                                      children: [
                                        (0, O.jsx)(`span`, {
                                          className: `text-[11px] text-amber-300 font-medium max-w-[140px] truncate`,
                                          children: e,
                                        }),
                                        (0, O.jsx)(`button`, {
                                          type: `button`,
                      ...
                      k.type === `checklist`
                        ? (0, O.jsxs)(`div`, {
                            ...
                            children: [
                              (0, O.jsxs)(`div`, {
                                className: `flex items-center justify-between border-b border-slate-700/40 pb-2.5`,
                                children: [
                                  (0, O.jsx)(`span`, {
                                    className: `text-xs text-slate-300 font-medium`,
                                    children: `📍 Link to Where Is It`,
                                  }),
                                  (0, O.jsxs)(`label`, {
                                    ...
                                    children: [
                                      (0, O.jsx)(`input`, {
                                        type: `checkbox`,
                                        checked: k.linkEnabled || !1,
                                        onChange: (e) =>
                                          A({
                                            linkEnabled: e.target.checked,
                                            linkUpdatesByItemId:
                                              e.target.checked &&
                                              !k.linkUpdatesByItemId
                                                ? {}
                              ...
                              (0, O.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, O.jsx)(`span`, {
                                    className: `text-xs text-slate-300 font-medium`,
                                    children: `⏱️ Pacing & Split Engine`,
                                  }),
                                  (0, O.jsxs)(`label`, {
                                    className: `relative inline-flex items-center cursor-pointer`,
                                    children: [
                                      (0, O.jsx)(`input`, {
                                        type: `checkbox`,
                                        checked: k.timerEnabled || !1,
                                        onChange: (e) =>
                                          A({ timerEnabled: e.target.checked }),
                                        className: `sr-only peer`,
                                      }),
                                      (0, O.jsx)(`div`, {
                                        className: `w-9 h-5 bg-slate-700 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-indigo-600`,
                                ...
                                children: [
                                  ...
                                  (0, O.jsxs)(`label`, {
                                    ...
                                    children: [
                                      ...
                                      (0, O.jsx)(`div`, {
                                        className: `w-8 h-4.5 bg-slate-700 rounded-full peer peer-checked:after:translate-x-full peer-checked:bg-indigo-600 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-3.5 after:w-3.5 after:transition-all`,
                                      }),
                                    ],
                                  }),
                                ],
                              ...
                              (0, O.jsxs)(`div`, {
                                ...
                                children: [
                                  (0, O.jsx)(`span`, {
                                    className: `text-xs text-slate-300 font-medium`,
                                    children: `📊 Analytical Review Storage`,
                                  }),
                                  (0, O.jsxs)(`div`, {
                                    ...
                                    children: [
                                      (k.history || []).length > 0 &&
                                        (0, O.jsx)(`button`, {
                                          onClick: () => Be(!ze),
                                          className: `text-[10px] bg-slate-900 px-2 py-0.5 rounded text-indigo-400 font-bold border border-indigo-900`,
                                          children: ze
                                            ? `Hide Logs`
                                            : `View Logs (${k.history.length})`,
                                        }),
                                      (0, O.jsxs)(`label`, {
                                        className: `relative inline-flex items-center cursor-pointer`,
                                        children: [
                              ...
                              k.timerEnabled &&
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    (0, O.jsxs)(`div`, {
                                      className: `flex gap-2 p-0.5 bg-slate-900 rounded-lg border border-slate-700/60`,
                                      children: [
                                        (0, O.jsx)(`button`, {
                                          type: `button`,
                                          onClick: () =>
                                            A({ timerMode: `simple` }),
                                          className: `flex-1 py-1 text-[11px] font-bold rounded transition uppercase ${k.timerMode === `task` ? `text-slate-400` : `bg-indigo-600 text-white`}`,
                                          children: `🔄 Pacing`,
                                        }),
                                        (0, O.jsx)(`button`, {
                                          type: `button`,
                                          onClick: () =>
                                            A({ timerMode: `task` }),
                                          className: `flex-1 py-1 text-[11px] font-bold rounded transition uppercase ${k.timerMode === `task` ? `bg-indigo-600 text-white` : `text-slate-400`}`,
                                          children: `🎯 Task Splits`,
                                        }),
                                      ],
                                    }),
                                    k.timerMode === `task` &&
                                      k.items.length > 0 &&
                                      (0, O.jsxs)(`div`, {
                                        className: `grid grid-cols-2 gap-2 bg-slate-900/50 p-2 rounded-xl text-xs`,
                                        children: [
                                          (0, O.jsxs)(`div`, {
                                            children: [
                                              (0, O.jsx)(`label`, {
                                                className: `block text-[10px] text-slate-400 font-medium mb-1`,
                                                children: `Start Track Point:`,
                                              }),
                                              (0, O.jsx)(`select`, {
                                                value: k.startTrackingItemId
                                                  ? String(
                                                      k.startTrackingItemId,
                                                    )
                                                  : ``,
                                                onChange: (e) =>
                                                  A({
                                                ...
                                                className: `bg-slate-800 w-full text-[11px] p-1 border border-slate-700 rounded text-slate-200`,
                                                children: k.items.map((e) =>
                                                  (0, O.jsx)(
                                                    `option`,
                                                    {
                                                      value: e.id,
                                          ...
                                          (0, O.jsxs)(`div`, {
                                            children: [
                                              (0, O.jsx)(`label`, {
                                                className: `block text-[10px] text-slate-400 font-medium mb-1`,
                                                children: `End Track Point (Auto Save):`,
                                              }),
                                              (0, O.jsx)(`select`, {
                                                value: k.endTrackingItemId
                                                  ? String(k.endTrackingItemId)
                                                  : ``,
                                                onChange: (e) =>
                                                  A({
                                                    endTrackingItemId:
                        ...
                        : (0, O.jsx)(`div`, {
                            className: `text-xs text-slate-400 py-1 italic`,
                            children: `📍 Directory Mode active. Central blueprint configuration enabled.`,
                          }),
                    ],
                  }),
                  ze &&
                    ...
                    (k.history || []).length > 0 &&
                    (0, O.jsxs)(`div`, {
                      className: `mb-4 bg-slate-950 border border-slate-800 rounded-2xl p-4 max-h-60 overflow-y-auto space-y-3`,
                      children: [
                        (0, O.jsx)(`h4`, {
                          className: `text-xs font-bold uppercase text-indigo-400 tracking-wider`,
                          children: `Analytical Completion Logs`,
                        }),
                        (k.history || []).map((e) =>
                          (0, O.jsxs)(
                            `div`,
                            {
                              className: `bg-slate-900 border border-slate-800 p-2.5 rounded-xl text-xs relative`,
                              children: [
                                (0, O.jsx)(`button`, {
                                  onClick: () => Qe(e.id),
                                  className: `absolute top-2 right-2 text-slate-500 hover:text-rose-400 text-xs font-bold`,
                                  children: `✕`,
                                }),
                                (0, O.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    (0, O.jsx)(`span`, {
                                      ...
                                      children: e.totalTime,
                                    }),
                                  ],
                                }),
                                (0, O.jsx)(`div`, {
                                  className: `space-y-1 pl-2 border-l border-slate-800`,
                                  children: e.splits?.map((e, t) =>
                                    (0, O.jsxs)(
                                      `div`,
                                      {
                    ...
                    children: [
                      (0, O.jsxs)(`div`, {
                        children: [
                          ...
                          k.type === `checklist` &&
                            k.focusModeEnabled &&
                            (0, O.jsxs)(`p`, {
                              className: `text-xs font-bold text-indigo-400 mt-0.5 tracking-wide`,
                              children: [
                                `📈 Execution: `,
                                mt,
                                ` Done /`,
                      ...
                      k.type === `checklist` &&
                        (0, O.jsx)(`button`, {
                          ...
                          className: `text-xs bg-slate-800 hover:bg-slate-700 text-indigo-400 border border-indigo-900 px-3 py-1 rounded-lg transition font-medium`,
                          children: `Reset All`,
                        }),
                    ],
                  }),
                  !k.focusModeEnabled &&
                    (0, O.jsx)(`form`, {
                      onSubmit: et,
                      className: `flex gap-2 mb-6 bg-slate-900/40 p-2.5 rounded-xl border border-slate-800`,
                      children:
                        k.type === `inventory`
                          ? (0, O.jsxs)(`div`, {
                              ...
                              children: [
                                (0, O.jsx)(`input`, {
                                  ...
                                  className: `bg-slate-800 text-xs border border-slate-700 rounded-lg px-3 py-2 text-slate-100`,
                                  required: !0,
                                }),
                                (0, O.jsxs)(`div`, {
                                  className: `flex gap-2`,
                                  children: [
                                    (0, O.jsx)(`input`, {
                                      type: `text`,
                                      placeholder: `Location (e.g. Desk Top Drawer)`,
                                      value: b,
                                      onChange: (e) => x(e.target.value),
                                      className: `flex-1 bg-slate-800 text-xs border border-slate-700 rounded-lg px-3 py-2 text-slate-100`,
                                      required: !0,
                                    }),
                                    (0, O.jsx)(`button`, {
                                      type: `submit`,
                                      className: `bg-indigo-600 hover:bg-indigo-500 px-4 rounded-lg text-xs font-bold`,
                                      children: `Add`,
                                    }),
                                  ],
                                }),
                  ...
                  k.items?.length === 0
                    ? (0, O.jsx)(`div`, {
                        className: `text-center py-8 text-slate-600 text-sm italic`,
                        children: `Blueprint is currently empty.`,
                      })
                    : k.type === `checklist` && k.focusModeEnabled
                      ? j
                        ? (0, O.jsxs)(`div`, {
                            onClick: () => tt(j.id),
                            className: `bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-indigo-500/80 p-6 rounded-2xl text-center shadow-xl cursor-pointer select-none transform active:scale-95 transition-all duration-300 ${Le === j.id ? `opacity-0 translate-x-4` : `opacity-100 translate-x-0`}`,
                            children: [
                              (0, O.jsx)(`span`, {
                                className: `text-[10px] uppercase font-bold tracking-widest text-indigo-400 block mb-2`,
                                children: `Active Action Target`,
                              }),
                              (0, O.jsx)(`div`, {
                                className: `text-xl font-bold text-white mb-4 leading-relaxed`,
                                children: j.text,
                              }),
                              (0, O.jsx)(`div`, {
                                className: `inline-block bg-indigo-950/80 border border-indigo-500/30 text-indigo-300 text-xs font-bold px-4 py-1.5 rounded-xl uppercase tracking-wider`,
                                children: `✓ Complete Step`,
                              }),
                            ],
                          })
                        : (0, O.jsxs)(`div`, {
                            className: `text-center p-6 bg-emerald-950/20 border border-emerald-500/30 rounded-2xl`,
                            children: [
                              (0, O.jsx)(`div`, {
                              ...
                              (0, O.jsx)(`div`, {
                                className: `text-sm font-bold text-emerald-400 uppercase tracking-wide`,
                                children: `Routine Complete!`,
                              }),
                              (0, O.jsx)(`p`, {
                                className: `text-xs text-slate-400 mt-1`,
                                children: `All blueprints checked and balanced successfully.`,
                              }),
                            ],
                          })
                      : (0, O.jsx)(`div`, {
                          className: `space-y-2`,
                          children: k.items?.map((t, n) => {
                            let r = ne === t.id,
                              i = k.items.findIndex((e) => e.id === t.id),
                              a = k.items.findIndex(
                                (e) =>
                                  String(e.id) ===
                                  String(k.startTrackingItemId),
                              ),
                              s = k.items.findIndex(
                                (e) =>
                                  String(e.id) === String(k.endTrackingItemId),
                              ),
                              c =
                                k.type === `checklist` &&
                                k.timerEnabled &&
                            ...
                            return (0, O.jsxs)(
                              `div`,
                              {
                                ...
                                onDragEnd: st,
                                onClick: () =>
                                  !r && k.type === `checklist` && tt(t.id),
                                className: `flex justify-between items-center p-3 rounded-xl border select-none transition-all duration-150 ${r ? `cursor-default` : k.type === `checklist` ? `cursor-pointer` : `cursor-grab active:cursor-grabbing`} ${ge === n ? `opacity-30 border-indigo-500 scale-[0.98]` : t.done ? `bg-emerald-950/10 border-emerald-500/20 text-slate-500` : `bg-slate-800 border-slate-700/70`}`,
                                children: [
                                  (0, O.jsxs)(`div`, {
                                    className: `flex items-center gap-3 overflow-hidden mr-2 flex-1`,
                                    children: [
                                      !k.focusModeEnabled &&
                                        (0, O.jsx)(`span`, {
                                          className: `text-slate-600 font-bold text-xs select-none shrink-0`,
                                          children: `⋮⋮`,
                                        }),
                                      k.type === `checklist` &&
                                        (0, O.jsx)(`div`, {
                                          className: `w-4.5 h-4.5 rounded border flex items-center justify-center text-[10px] transition shrink-0 ${t.done ? `bg-emerald-600 border-emerald-500 text-white` : `border-slate-500`}`,
                                          children: t.done && `✓`,
                                        }),
                                      (0, O.jsx)(`div`, {
                                          ...
                                          ? (0, O.jsxs)(`div`, {
                                              ...
                                              children: [
                                                (0, O.jsx)(`input`, {
                                                  ...
                                                  onChange: (e) =>
                                                    ie(e.target.value),
                                                  className: `bg-slate-900 border border-indigo-500 rounded px-2 py-1 text-xs text-slate-100`,
                                                }),
                                                k.type === `inventory` &&
                                                  (0, O.jsxs)(`div`, {
                                                    className: `flex flex-col gap-1.5 w-full`,
                                                    children: [
                                                          ...
                                                          (0, O.jsxs)(`div`, {
                                                            ...
                                                            children: [
                                                              (0, O.jsx)(
                                                                ...
                                                                {
                                                                  className: `sr-only`,
                                                                  children: `Location selection mode`,
                                                                },
                                                              ),
                                                              (0, O.jsxs)(
                                                                `select`,
                                                                {
                                                                  ...
                                                                  className: `w-full bg-slate-900 border border-indigo-500 rounded px-2 py-1 text-xs text-slate-100`,
                                                                  children: [
                                                                    (0, O.jsx)(
                                                                      `option`,
                                                                      {
                                                              ...
                                                              le === `preset`
                                                                ...
                                                                : (0, O.jsx)(
                                                                    `input`,
                                                                    {
                                                                      ...
                                                                      placeholder: `e.g. Desk Top Drawer`,
                                                                      className: `w-full bg-slate-900 border border-indigo-500 rounded px-2 py-1 text-xs text-slate-100`,
                                                                    },
                                                                  ),
                                                          }),
                                                      ...
                                                      le === `custom` &&
                                                        (0, O.jsx)(`div`, {
                                                          ...
                                                          children: `Custom locations won’t be added to presets.`,
                                                        }),
                                                    ],
                                                  }),
                                                (0, O.jsxs)(`div`, {
                                                  ...
                                                  children: [
                                                    ...
                                                    (0, O.jsx)(`button`, {
                                                      onClick: () => rt(t.id),
                                                      className: `text-[10px] bg-emerald-600 text-white px-2.5 py-1 rounded`,
                                                      children: `Save`,
                                                    }),
                                                  ],
                                                }),
                                                  ...
                                                  ? (0, O.jsxs)(`div`, {
                                                      ...
                                                      children: [
                                                        (0, O.jsx)(`span`, {
                                                          onClick: (e) =>
                                                            nt(t, e),
                                                          className: `font-semibold text-sm text-slate-200 hover:text-indigo-400 transition cursor-text`,
                                                          children: t.text,
                                                        }),
                                                        (0, O.jsxs)(`span`, {
                                                          onClick: (e) =>
                                                            nt(t, e),
                                                          className: `text-xs text-amber-400 font-medium bg-amber-950/40 border border-amber-900/30 px-2 py-0.5 rounded-md inline-block max-w-fit cursor-text`,
                                                          children: [
                                                            `📍 `,
                                                            t.location ||
                                                              `Unmapped`,
                                                  ...
                                                  : (0, O.jsxs)(O.Fragment, {
                                                      children: [
                                                        (0, O.jsx)(`span`, {
                                                          onClick: (e) =>
                                                            nt(t, e),
                                                          className: `font-medium text-sm block transition hover:text-indigo-400 cursor-text ${t.done ? `line-through text-slate-600` : `text-slate-200`}`,
                                                          children: t.text,
                                                        }),
                                                        t.done &&
                                                          t.splitMetrics &&
                                                          (0, O.jsxs)(`div`, {
                                                            className: `text-[10px] font-mono font-semibold text-emerald-400 mt-0.5 bg-emerald-950/60 inline-block px-1.5 py-0.5 rounded border border-emerald-500/10`,
                                                            children: [
                                                              `⏱️ Split: `,
                                                              t.splitMetrics
                                                                .splitText,
                                                        ...
                                                        !t.done &&
                                                          c &&
                                                          (0, O.jsx)(`span`, {
                                                            className: `text-[9px] uppercase font-bold tracking-wider text-indigo-400/80 block mt-0.5`,
                                                            children: `⏱️ Split Target Point`,
                                                          }),
                                                      ],
                                                    }),
                                                k.type === `checklist` &&
                                                  ...
                                                  !t.done &&
                                                  (0, O.jsxs)(`div`, {
                                                    className: `mt-2 bg-slate-900/25 border border-indigo-500/15 rounded-xl px-2.5 py-2 flex flex-col gap-2`,
                                                    onClick: (e) =>
                                                      e.stopPropagation(),
                                                    children: [
                                                      (0, O.jsxs)(`div`, {
                                                        ...
                                                        children: [
                                                          (0, O.jsxs)(`div`, {
                                                            ...
                                                            children: [
                                                              ...
                                                              (0, O.jsx)(
                                                                `div`,
                                                                {
                                                                  className: `text-[10px] text-slate-400/90 truncate font-semibold`,
                                                                  children:
                                                                    t.text,
                                                                },
                                                              ),
                                                          ...
                                                          (0, O.jsx)(`button`, {
                                                            ...
                                                            onClick: () =>
                                                              wt(t.id),
                                                            className: `shrink-0 text-[10px] bg-rose-950/35 hover:bg-rose-950/55 border border-rose-500/20 hover:border-rose-500/40 text-rose-200 px-2 py-1 rounded-lg transition`,
                                                            children: `✕`,
                                                          }),
                                                        ],
                                                      }),
                                                          ...
                                                          (0, O.jsxs)(`div`, {
                                                            ...
                                                            children: [
                                                              (0, O.jsx)(
                                                                `label`,
                                                                {
                                                                  className: `block text-[9px] text-slate-500 font-medium mb-1`,
                                                                  children: `Where`,
                                                                },
                                                              ),
                                                              (0, O.jsxs)(
                                                                `select`,
                                                                {
                                                                  ...
                                                                  className: `bg-slate-800 w-full text-[10px] p-1 border border-slate-700 rounded text-slate-200`,
                                                                  children: [
                                                                    (0, O.jsx)(
                                                                      `option`,
                                                                      {
                                                                    ...
                                                                    o.length >
                                                                      ...
                                                                      O.jsxs)(
                                                                        `select`,
                                                                        {
                                                                          ...
                                                                          className: `bg-slate-900/40 w-full text-[10px] p-1 border border-slate-700 rounded text-slate-300`,
                                                                          children:
                                                                            [
                                                                              (0,
                                                                              O.jsx)(
                                    ...
                                    (0, O.jsxs)(`div`, {
                                      ...
                                      children: [
                                        k.type === `inventory` &&
                                          (0, O.jsx)(`button`, {
                                            onClick: (e) => nt(t, e),
                                            className: `p-1 text-slate-500 hover:text-indigo-400 rounded text-xs`,
                                            children: `✏️`,
                                          }),
                                        (0, O.jsx)(`button`, {
                                          onClick: (e) => it(t.id, e),
                                          className: `p-1 text-slate-500 hover:text-rose-400 rounded text-xs`,
                                          children: `✕`,
                                        }),
                                      ],
                                    }),
            ...
            : (0, O.jsxs)(`div`, {
                children: [
                  (0, O.jsxs)(`form`, {
                    onSubmit: $e,
                    className: `flex flex-col gap-3 mb-6 bg-slate-800/40 p-4 border border-slate-800 rounded-2xl shadow-sm`,
                    children: [
                      (0, O.jsx)(`input`, {
                        type: `text`,
                        placeholder: `List Name (e.g. Work Backpack Setup)`,
                        value: p,
                        onChange: (e) => m(e.target.value),
                        className: `w-full bg-slate-800 border border-slate-700 rounded-xl px-4 py-2.5 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-indigo-500 transition`,
                      }),
                      (0, O.jsxs)(`div`, {
                        className: `flex gap-2`,
                        children: [
                          (0, O.jsx)(`button`, {
                            type: `button`,
                            onClick: () => g(`checklist`),
                            className: `flex-1 py-2 text-xs font-bold rounded-xl border transition ${h === `checklist` ? `bg-indigo-600 border-indigo-500 text-white` : `bg-slate-900 border-slate-800 text-slate-400`}`,
                            children: `☑️ Checklist`,
                          }),
                          (0, O.jsx)(`button`, {
                            type: `button`,
                            onClick: () => g(`inventory`),
                            className: `flex-1 py-2 text-xs font-bold rounded-xl border transition ${h === `inventory` ? `bg-indigo-600 border-indigo-500 text-white` : `bg-slate-900 border-slate-800 text-slate-400`}`,
                            children: `📍 Where Is It List`,
                          }),
                          (0, O.jsx)(`button`, {
                            type: `button`,
                            onClick: () => g(`group`),
                            className: `flex-1 py-2 text-xs font-bold rounded-xl border transition ${h === `group` ? `bg-indigo-600 border-indigo-500 text-white` : `bg-slate-900 border-slate-800 text-slate-400`}`,
                            children: `🧩 Group`,
                          }),
                          (0, O.jsx)(`button`, {
                            type: `submit`,
                            className: `bg-slate-200 hover:bg-white text-slate-900 font-bold px-5 rounded-xl text-sm transition`,
                            children: `+`,
                          }),
                        ],
                      }),
                  ...
                  (0, O.jsx)(`div`, {
                    ...
                    children: (() => {
                      let o = new Map();
                      for (let e of n) o.set(String(e.id), []);
                      let s = [];
                      for (let t of e) {
                        let e = t.groupId ? String(t.groupId) : u;
                        n.find((t) => String(t.id) === e)
                          ? o.get(e).push(t)
                          : s.push(t);
                      }
                      let c = (e) => {
                          let r = e.items?.filter((e) => e.done).length || 0,
                            i = ee === e.id,
                            a = e.groupId ? String(e.groupId) : u,
                            o = (n) => {
                              let r = String(n);
                              t((t) =>
                                t.map((t) =>
                          ...
                          return (0, O.jsxs)(
                            `div`,
                            {
                              ...
                              onDragStart: () => {
                                i ||
                                  (D(null),
                                  (window.__draggedChecklistListId = String(
                                    e.id,
                                  )));
                              },
                              onClick: () => !i && f(e.id),
                              className: `bg-slate-800/60 border rounded-xl p-4 flex justify-between items-center transition cursor-pointer border-slate-800 hover:border-slate-700`,
                              children: [
                                (0, O.jsxs)(`div`, {
                                  className: `flex items-center gap-3 overflow-hidden flex-1 mr-2`,
                                  children: [
                                    (0, O.jsx)(`span`, {
                                      className: `text-slate-600 font-bold select-none text-lg shrink-0`,
                                      children: `⋮⋮`,
                                    }),
                                    (0, O.jsx)(`div`, {
                                      className: `flex-1 min-w-0`,
                                      children: i
                                        ? (0, O.jsxs)(`div`, {
                                            ...
                                            children: [
                                              (0, O.jsx)(`input`, {
                                                ...
                                                onChange: (e) =>
                                                  te(e.target.value),
                                                className: `bg-slate-900 border border-indigo-500 rounded-lg px-2 py-1 text-slate-100 w-full text-base font-semibold`,
                                                autoFocus: !0,
                                              }),
                                              (0, O.jsx)(`button`, {
                                                onClick: () => lt(e.id),
                                                className: `text-xs bg-emerald-600 px-2.5 py-1.5 rounded-lg text-white`,
                                                children: `Save`,
                                              }),
                                            ],
                                          })
                                        : (0, O.jsxs)(O.Fragment, {
                                            children: [
                                              (0, O.jsxs)(`h3`, {
                                                className: `font-semibold text-slate-200 text-base truncate flex items-center gap-2`,
                                                children: [
                                                  e.name,
                                                  (0, O.jsx)(`span`, {
                                                    className: `text-[10px] font-bold px-1.5 py-0.5 rounded ${e.type === `inventory` ? `bg-amber-950 text-amber-400 border border-amber-800/40` : `bg-indigo-950 text-indigo-400 border border-indigo-800/40`}`,
                                                    children:
                                                      e.type === `inventory`
                                                        ? `Where Is It`
                                                        : `Checklist`,
                                              ...
                                              (0, O.jsx)(`p`, {
                                                ...
                                                children:
                                                  e.type === `inventory`
                                                    ? `${e.items?.length || 0} locations mapped`
                                                    : `${r} / ${e.items?.length || 0} tasks ticked`,
                                              }),
                                              (0, O.jsxs)(`div`, {
                                                className: `mt-2`,
                                                children: [
                                                  ...
                                                  (0, O.jsxs)(`select`, {
                                                    ...
                                                    onClick: (e) =>
                                                      e.stopPropagation(),
                                                    className: `bg-slate-900/60 border border-slate-700 rounded-lg px-2 py-1 text-[11px] text-slate-200`,
                                                    children: [
                                                      (0, O.jsx)(`option`, {
                                                        value: u,
                                                        children: `Ungrouped`,
                        ...
                        l = (e) => {
                          let n = window.__draggedChecklistListId;
                          n &&
                            t((t) =>
                              t.map((t) =>
                                String(t.id) === String(n)
                                  ? { ...t, groupId: e }
                                  : t,
                              ),
                            );
                        ...
                        d = [...n].map((e) => {
                          ...
                          return (0, O.jsxs)(
                            `div`,
                            {
                              children: [
                                (0, O.jsxs)(`div`, {
                                  className: `bg-slate-800/60 border border-slate-800 rounded-xl p-3 flex items-center justify-between`,
                                  onClick: () =>
                                    a((t) => ({ ...t, [e.id]: !t[e.id] })),
                                  children: [
                                    (0, O.jsxs)(`div`, {
                                    ...
                                    (0, O.jsxs)(`div`, {
                                      ...
                                      children: [
                                        (0, O.jsx)(`button`, {
                                          onClick: (t) => {
                                            (t.stopPropagation(),
                                              setEditingGroupId(e.id),
                                              setEditingGroupName(e.name));
                                          },
                                          className: `p-2 text-slate-500 hover:text-indigo-400 rounded-lg text-xs`,
                                          children: `✏️`,
                                        }),
                                        (0, O.jsx)(`button`, {
                                          onClick: (i) => {
                                          ...
                                          className: `p-2 text-slate-500 hover:text-rose-400 rounded-lg text-xs`,
                                          children: `🗑️`,
                                        }),
                                      ],
                                    }),
                                ...
                                !d &&
                                  (0, O.jsx)(`div`, {
                                    className: `mt-2 bg-slate-900/20 border border-slate-800 rounded-xl p-2`,
...
(0, y.createRoot)(document.getElementById(`root`)).render(
  (0, O.jsx)(v.StrictMode, { children: (0, O.jsx)(De, {}) }),
);
