import { n as e, t as n, r as t } from "./index-DX4gkzi3.js";
var r = class {
  constructor() {
...
var s = class {
    ...
    unpack_uint64() {
      let e = this.read(8),
        t =
          ((((((e[0] * 256 + e[1]) * 256 + e[2]) * 256 + e[3]) * 256 + e[4]) *
            256 +
            e[5]) *
            256 +
            e[6]) *
    ...
    unpack_double() {
      let e = this.unpack_uint32(),
        ...
        n = e >> 31,
        r = ((e >> 20) & 2047) - 1023,
        i = ((e & 1048575) | 1048576) * 2 ** (r - 20) + t * 2 ** (r - 52);
      return (n === 0 ? 1 : -1) * i;
    }
    read(e) {
      let t = this.index;
  ...
  c = class {
    ...
    pack(e) {
      if (typeof e == `string`) this.pack_string(e);
        ...
        e === !0
          ...
          : e === !1 && this._bufferBuilder.append(194);
    ...
    pack_uint32(e) {
      let t = e & 4294967295;
      (this._bufferBuilder.append((t & 4278190080) >>> 24),
    ...
    pack_int16(e) {
      (this._bufferBuilder.append((e & 65280) >> 8),
        this._bufferBuilder.append(e & 255));
    }
    pack_int32(e) {
      (this._bufferBuilder.append((e >>> 24) & 255),
        this._bufferBuilder.append((e & 16711680) >>> 16),
        this._bufferBuilder.append((e & 65280) >>> 8),
        this._bufferBuilder.append(e & 255));
    }
    pack_int64(e) {
      let t = Math.floor(e / 2 ** 32),
        n = e % 2 ** 32;
      (this._bufferBuilder.append((t & 4278190080) >>> 24),
        this._bufferBuilder.append((t & 16711680) >>> 16),
        this._bufferBuilder.append((t & 65280) >>> 8),
...
function ne(e) {
  ...
  if (e === void 0 || !e.navigator || !e.navigator.userAgent)
  ...
  if (n.userAgentData && n.userAgentData.brands) {
    ...
    if (e) {
      ...
      if (t >= 90) return { browser: `chrome`, version: t };
    }
  }
  if (n.mozGetUserMedia)
    ((t.browser = `firefox`),
      (t.version = parseInt(d(n.userAgent, /Firefox\/(\d+)\./, 1))));
  else if (
    ...
    ((t.browser = `chrome`),
      (t.version =
        parseInt(d(n.userAgent, /Chrom(e|ium)\/(\d+)\./, 2)) || null));
  else if (e.RTCPeerConnection && n.userAgent.match(/AppleWebKit\/(\d+)\./))
    ((t.browser = `safari`),
      (t.version = parseInt(d(n.userAgent, /AppleWebKit\/(\d+)\./, 1))),
      (t.supportsUnifiedPlan =
        e.RTCRtpTransceiver &&
        `currentDirection` in e.RTCRtpTransceiver.prototype),
      (t._safariVersion = d(n.userAgent, /Version\/(\d+(\.?\d+))/, 1)));
  ...
  let r = function (e) {
      ...
      return (
        Object.keys(e).forEach((n) => {
          ...
          r.exact !== void 0 && typeof r.exact != `number`
    ...
    i = function (e, i) {
      ...
      if (
        ((e = JSON.parse(JSON.stringify(e))), e && typeof e.audio == `object`)
      ) {
        let t = function (e, t, n) {
          t in e && !(n in e) && ((e[n] = e[t]), delete e[t]);
        };
        ((e = JSON.parse(JSON.stringify(e))),
          t(e.audio, `autoGainControl`, `googAutoGainControl`),
      ...
      if (e && typeof e.video == `object`) {
        ...
        if (
          ...
          let t;
          if (
            (a.exact === `environment` || a.ideal === `environment`
              ? (t = [`back`, `rear`])
              : (a.exact === `user` || a.ideal === `user`) && (t = [`front`]),
            t)
          )
            return n.mediaDevices.enumerateDevices().then((n) => {
              ...
              return (
                !o && n.length && t.includes(`back`) && (o = n[n.length - 1]),
                o &&
                  (e.video.deviceId = a.exact
                    ? { exact: o.deviceId }
                    : { ideal: o.deviceId }),
                (e.video = r(e.video)),
                oe(`chrome: ` + JSON.stringify(e)),
                i(e)
              );
            });
        }
      ...
      return (oe(`chrome: ` + JSON.stringify(e)), i(e));
    },
    a = function (e) {
      return t.version >= 64
        ? e
...
var ce = e({
  fixNegotiationNeeded: () => he,
  shimAddTrackRemoveTrack: () => me,
  shimAddTrackRemoveTrackWithNative: () => pe,
  shimGetSendersWithDtmf: () => de,
  shimGetUserMedia: () => se,
  shimMediaStream: () => le,
  shimOnTrack: () => ue,
  shimPeerConnection: () => g,
  shimSenderReceiverGetStats: () => fe,
});
function le(e) {
  ...
  if (!(`getStats` in e.RTCRtpSender.prototype)) {
    ...
    (n &&
      ...
      (e.RTCRtpSender.prototype.getStats = function () {
        let e = this;
        return this._pc.getStats().then((t) => ae(t, e.track, !0));
      }));
  }
  if (!(`getStats` in e.RTCRtpReceiver.prototype)) {
    ...
    (t &&
      ...
      (e.RTCRtpReceiver.prototype.getStats = function () {
        let e = this;
        return this._pc.getStats().then((t) => ae(t, e.track, !1));
      }));
  }
  if (
    !(
  ...
  e.RTCPeerConnection.prototype.addTrack = function (e, n) {
    ...
    return (
      this._shimmedLocalStreams[n.id]
        ? this._shimmedLocalStreams[n.id].indexOf(r) === -1 &&
    ...
    return (
      ...
      e &&
        Object.keys(this._shimmedLocalStreams).forEach((t) => {
          ...
          (n !== -1 && this._shimmedLocalStreams[t].splice(n, 1),
            this._shimmedLocalStreams[t].length === 1 &&
...
function me(e, t) {
  if (!e.RTCPeerConnection) return;
  if (e.RTCPeerConnection.prototype.addTrack && t.version >= 65) return pe(e);
  ...
  ((e.RTCPeerConnection.prototype.removeStream = function (e) {
    ...
    (e.RTCPeerConnection.prototype.addTrack = function (t, n) {
      ...
      if (r.length !== 1 || !r[0].getTracks().find((e) => e === t))
        throw new DOMException(
  ...
  e.RTCPeerConnection.prototype.setLocalDescription = function () {
    return (
      !arguments.length ||
        !arguments[0].type ||
        (arguments[0] = o(this, arguments[0])),
    ...
    f(e, `negotiationneeded`, (e) => {
      ...
      if (
        !(
          (t.version < 72 ||
            (n.getConfiguration &&
              n.getConfiguration().sdpSemantics === `plan-b`)) &&
...
var ve = e({
  shimAddTransceiver: () => Te,
  shimCreateAnswer: () => Oe,
  shimCreateOffer: () => De,
  shimGetDisplayMedia: () => _e,
  shimGetParameters: () => Ee,
  shimGetStats: () => be,
  shimGetUserMedia: () => ge,
  shimOnTrack: () => ye,
  shimPeerConnection: () => _,
  shimRTCDataChannel: () => we,
  shimReceiverGetStats: () => Se,
  shimRemoveStream: () => Ce,
  shimSenderGetStats: () => xe,
});
function ye(e) {
  typeof e == `object` &&
    e.RTCTrackEvent &&
...
function Te(e, t) {
  if (!(typeof e == `object` && e.RTCPeerConnection) || t.version >= 110)
    return;
      ...
      if (t) {
        ...
        (!(`encodings` in n) ||
          (n.encodings.length === 1 &&
            Object.keys(n.encodings[0]).length === 0)) &&
          ((n.encodings = e),
          (t.sendEncodings = e),
...
var ke = e({
  ...
  shimGetUserMedia: () => b,
  shimLocalStreamsAPI: () => Ae,
  shimRTCIceServerUrls: () => S,
  shimRemoteStreamsAPI: () => v,
  shimTrackEventTransceiver: () => C,
});
function Ae(e) {
        ...
        this._onaddstreampoly ||
          this.addEventListener(
            ...
            (this._onaddstreampoly = function (t) {
              t.streams.forEach((t) => {
                if (
                  ((e._remoteStreams ||= []), e._remoteStreams.indexOf(t) >= 0)
                )
                  return;
...
function b(e) {
  ...
  if (t.mediaDevices && t.mediaDevices.getUserMedia) {
    ...
    t.mediaDevices.getUserMedia = (e) => n(x(e));
  }
  !t.getUserMedia &&
    t.mediaDevices &&
...
function x(e) {
  return e && e.video !== void 0
    ? Object.assign({}, e, { video: ie(e.video) })
    : e;
}
function S(e) {
  if (!e.RTCPeerConnection) return;
...
function je(e) {
  ...
  e.RTCPeerConnection.prototype.createOffer = function (e) {
    if (e) {
      e.offerToReceiveAudio !== void 0 &&
        (e.offerToReceiveAudio = !!e.offerToReceiveAudio);
      let t = this.getTransceivers().find(
        (e) => e.receiver.track.kind === `audio`,
      );
      (e.offerToReceiveAudio === !1 && t
...
`,
      ...
      (n.writeCandidate = function (e) {
        ...
        t.push(e.foundation);
        let n = e.component;
        (n === `rtp` ? t.push(1) : n === `rtcp` ? t.push(2) : t.push(n),
...
`
      ...
      (n.getIceParameters = function (e, t) {
        let r = n.matchPrefix(e + t, `a=ice-ufrag:`)[0],
...
`),
      ...
      (n.parseRtpParameters = function (e) {
        ...
        for (let i = 3; i < r.length; i++) {
          ...
          if (o) {
            let r = n.parseRtpMap(o),
              i = n.matchPrefix(e, `a=fmtp:` + a + ` `);
            switch (
              ((r.parameters = i.length ? n.parseFmtp(i[0]) : {}),
              (r.rtcpFeedback = n
          ...
          u.length &&
            ((u =
              u[0].indexOf(`b=TIAS:`) === 0
                ...
                : u[0].indexOf(`b=AS:`) === 0
                  ? parseInt(u[0].substring(5), 10) * 1e3 * 0.95 - 2e3 * 8
                  : void 0),
            t.forEach((e) => {
              e.maxBitrate = u;
            })),
...
`),
      ...
      (n.parseMsid = function (e) {
        ...
        if (r.length === 1)
          return (
            (t = r[0].substring(7).split(` `)),
            { stream: t[0], track: t[1] }
          );
        let i = n
          .matchPrefix(e, `a=ssrc:`)
          .map((e) => n.parseSsrcMedia(e))
          .filter((e) => e.attribute === `msid`);
        if (i.length > 0)
          return ((t = i[0].value.split(` `)), { stream: t[0], track: t[1] });
      }),
      (n.parseSctpDescription = function (e) {
        let t = n.parseMLine(e),
...
`
  ...
  Pe = e({
    removeExtmapAllowMixed: () => A,
    shimAddIceCandidateNullOrEmpty: () => j,
    shimConnectionState: () => k,
    shimMaxMessageSize: () => D,
    shimParameterlessSetLocalDescription: () => M,
    shimRTCIceCandidate: () => T,
    shimRTCIceCandidateRelayProtocol: () => E,
    shimSendThrowTypeError: () => O,
  }),
  w = t(Ne());
function T(e) {
  if (
  ...
  ((e.RTCIceCandidate = function (e) {
    if (
      (typeof e == `object` &&
        ...
        ((e = JSON.parse(JSON.stringify(e))),
        (e.candidate = e.candidate.substring(2))),
      e.candidate && e.candidate.length)
    ) {
      let n = new t(e),
        r = w.default.parseCandidate(e.candidate);
...
function E(e) {
  !e.RTCIceCandidate ||
    ...
    f(e, `icecandidate`, (e) => {
      if (e.candidate) {
        let t = w.default.parseCandidate(e.candidate.candidate);
        t.type === `relay` &&
...
function D(e, t) {
  if (
    !e.RTCPeerConnection ||
    (t.browser === `chrome` && t.version > 102) ||
    (t.browser === `firefox` && t.version >= 113)
  )
    return;
  ...
  let n = function (e) {
      if (!e || !e.sdp) return !1;
      let t = w.default.splitSections(e.sdp);
      return (
        t.shift(),
        t.some((e) => {
          let t = w.default.parseMLine(e);
          return (
            t && t.kind === `application` && t.protocol.indexOf(`SCTP`) !== -1
          );
        })
      );
    },
    ...
    a = function (e, n) {
      ...
      let i = w.default.matchPrefix(e.sdp, `a=max-message-size:`);
      return (
        i.length > 0
          ? (r = parseInt(i[0].substring(19), 10))
          : t.browser === `firefox` && n !== -1 && (r = 2147483637),
        r
      );
    },
...
function O(e, t) {
  ...
  function n(e, t) {
    ...
    e.send = function () {
      ...
      if (e.readyState === `open` && t.sctp && i > t.sctp.maxMessageSize)
        throw TypeError(
  ...
  ((e.RTCPeerConnection.prototype.createDataChannel = function () {
    ...
    f(e, `datachannel`, (e) => (n(e.channel, e.target), e)));
}
function k(e) {
  if (
    !e.RTCPeerConnection ||
...
function M(e, t) {
  ...
  !n ||
    ...
    (e.RTCPeerConnection.prototype.setLocalDescription = function () {
      ...
      return e.sdp || (e.type !== `offer` && e.type !== `answer`)
        ? n.apply(this, [e])
        : (e.type === `offer` ? this.createOffer : this.createAnswer)
            .apply(this)
...
var Ie = Fe({ window: typeof window > `u` ? void 0 : window });
function N(e, t, n, r) {
    ...
    ((this.chunkedMTU = 16300),
      ...
      (this.chunk = (e) => {
        let t = [],
          ...
          a = 0;
        for (; a < n; ) {
          let o = Math.min(n, a + this.chunkedMTU),
            s = e.slice(a, o),
            c = { __peerData: this._dataCount, n: i, data: s, total: r };
          (t.push(c), (a = o), i++);
        }
...
var P = Ie.default || Ie,
  F = new (class {
    ...
    getBrowser() {
      return P.browserDetails.browser;
    }
    getVersion() {
      return P.browserDetails.version || 0;
    }
    isUnifiedPlanSupported() {
      let e = this.getBrowser(),
        t = P.browserDetails.version || 0;
  ...
  ze = (e) => !e || /^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e),
  ...
  I = new (class extends Le {
    ...
    constructor(...e) {
      (super(...e),
        ...
        (this.defaultConfig = Ve),
        (this.browser = F.getBrowser()),
        (this.browserVersion = F.getVersion()),
        (this.pack = o),
        (this.unpack = a),
        (this.supports = (function () {
          let e = {
            browser: F.isBrowserSupported(),
            webRTC: F.isWebRTCSupported(),
            audioVideo: !1,
            data: !1,
            binaryBlob: !1,
            reliable: !1,
          ...
          let t;
          try {
            ((t = new RTCPeerConnection(Ve)), (e.audioVideo = !0));
            let n;
            try {
              ((n = t.createDataChannel(`_PEERJSTEST`, { ordered: !0 })),
                (e.data = !0),
                (e.reliable = !!n.ordered));
              try {
                ((n.binaryType = `blob`), (e.binaryBlob = !F.isIOS));
              } catch {}
            } catch {
            } finally {
              n && n.close();
...
function B() {}
Object.create &&
  ((B.prototype = Object.create(null)), new B().__proto__ || (z = !1));
function We(e, t, n) {
...
function V(e, t) {
  --e._eventsCount === 0 ? (e._events = new B()) : delete e._events[t];
}
function H() {
...
((H.prototype.eventNames = function () {
  ...
  for (n in (t = this._events)) Ue.call(t, n) && e.push(z ? n.slice(1) : n);
  ...
  (H.prototype.emit = function (e, t, n, r, i, a) {
    var o = z ? z + e : e;
    ...
    if (s.fn) {
      ...
      var d = s.length,
        f;
      for (u = 0; u < d; u++)
        switch ((s[u].once && this.removeListener(e, s[u].fn, void 0, !0), c)) {
          case 1:
          ...
          default:
            if (!l)
              for (f = 1, l = Array(c - 1); f < c; f++) l[f - 1] = arguments[f];
  ...
  (H.prototype.on = function (e, t, n) {
    return Ge(this, e, t, n, !1);
  }),
  (H.prototype.once = function (e, t, n) {
    return Ge(this, e, t, n, !0);
  }),
  (H.prototype.removeListener = function (e, t, n, r) {
    var i = z ? z + e : e;
    if (!this._events[i]) return this;
    if (!t) return (V(this, i), this);
    var a = this._events[i];
    if (a.fn)
      a.fn === t && (!r || a.once) && (!n || a.context === n) && V(this, i);
    else {
      for (var o = 0, s = [], c = a.length; o < c; o++)
        (a[o].fn !== t || (r && !a[o].once) || (n && a[o].context !== n)) &&
          s.push(a[o]);
      s.length ? (this._events[i] = s.length === 1 ? s[0] : s) : V(this, i);
    }
    return this;
  }),
  (H.prototype.removeAllListeners = function (e) {
    ...
    return (
      e
        ? ((t = z ? z + e : e), this._events[t] && V(this, t))
        : ((this._events = new B()), (this._eventsCount = 0)),
      this
    );
  }),
  ...
  (R = H));
var U = {};
(N(U, `ConnectionType`, () => W),
  N(U, `PeerErrorType`, () => G),
  N(U, `BaseConnectionErrorType`, () => K),
  N(U, `DataConnectionErrorType`, () => q),
  N(U, `SerializationType`, () => J),
  N(U, `SocketEventType`, () => Y),
  N(U, `ServerMessageType`, () => X));
var W = (function (e) {
  ...
  Ke = `1.5.5`,
  qe = class extends R.EventEmitter {
    ...
    start(e, t) {
      ...
      this._socket ||
        !this._disconnected ||
        ((this._socket = new WebSocket(n + `&version=1.5.5`)),
        (this._disconnected = !1),
        (this._socket.onmessage = (e) => {
          let t;
          try {
            ((t = JSON.parse(e.data)), L.log(`Server message received:`, t));
          } catch {
            L.log(`Invalid server message`, e.data);
            return;
          }
          this.emit(Y.Message, t);
        }),
        (this._socket.onclose = (e) => {
          this._disconnected ||
            (L.log(`Socket closed.`, e),
            this._cleanup(),
            (this._disconnected = !0),
            this.emit(Y.Disconnected));
        }),
        (this._socket.onopen = () => {
          this._disconnected ||
    ...
    _sendHeartbeat() {
      if (!this._wsOpen()) {
        L.log(`Cannot send heartbeat, because socket closed`);
        return;
      }
      let e = JSON.stringify({ type: X.Heartbeat });
    ...
    send(e) {
      ...
      if (!e.type) {
        this.emit(Y.Error, `Invalid message`);
        return;
      }
  ...
  Je = class {
    ...
    _setupListeners(e) {
      ...
      (L.log(`Listening for ICE candidates.`),
        (e.onicecandidate = (e) => {
          !e.candidate ||
            !e.candidate.candidate ||
            (L.log(`Received ICE candidates for ${t}:`, e.candidate),
            i.socket.send({
              type: X.Candidate,
    ...
    cleanup() {
      L.log(`Cleaning up PeerConnection to ` + this.connection.peer);
      ...
      ((this.connection.peerConnection = null),
        (e.onicecandidate =
          ...
          e.ontrack =
            () => {}));
      let t = e.signalingState !== `closed`,
        n = !1,
        r = this.connection.dataChannel;
      (r && (n = !!r.readyState && r.readyState !== `closed`),
        (t || n) && e.close());
    }
    async _makeOffer() {
      let e = this.connection.peerConnection,
      ...
      try {
        ...
        try {
          (await e.setLocalDescription(n),
            L.log(`Set localDescription:`, n, `for:${this.connection.peer}`));
          let r = {
            sdp: n,
          ...
          e !=
            ...
            (t.emitError(G.WebRTC, e),
            L.log(`Failed to setLocalDescription, `, e));
        }
      } catch (e) {
        (t.emitError(G.WebRTC, e), L.log(`Failed to createOffer, `, e));
      }
    }
    async _makeAnswer() {
      let e = this.connection.peerConnection,
      ...
      try {
        ...
        (t.emitError(G.WebRTC, e), L.log(`Failed to create answer, `, e));
      }
    }
    async handleSDP(e, t) {
      ...
      L.log(`Setting remote description`, t);
      let i = this;
      try {
        (await n.setRemoteDescription(t),
          L.log(`Set remoteDescription:${e} for:${this.connection.peer}`),
          e === `OFFER` && (await i._makeAnswer()));
      } catch (e) {
        (r.emitError(G.WebRTC, e),
          L.log(`Failed to setRemoteDescription, `, e));
      }
    }
    async handleCandidate(e) {
      L.log(`handleCandidate:`, e);
      try {
        (await this.connection.peerConnection.addIceCandidate(e),
          L.log(`Added ICE candidate for:${this.connection.peer}`));
      } catch (e) {
        (this.connection.provider.emitError(G.WebRTC, e),
          L.log(`Failed to handleCandidate, `, e));
      }
    }
    _addTracksToConnection(e, t) {
      if (
        (L.log(`add tracks from stream ${e.id} to peer connection`),
        !t.addTrack)
      )
        return L.error(
    ...
    _addStreamToMediaConnection(e, t) {
      (L.log(`add stream ${e.id} to media connection ${t.connectionId}`),
        t.addStream(e));
    }
  },
  Z = class extends R.EventEmitter {
    emitError(e, t) {
      (L.error(`Error:`, t), this.emit(`error`, new Ye(`${e}`, t)));
    }
  },
  Ye = class extends Error {
    constructor(e, t) {
      (typeof t == `string` ? super(t) : (super(), Object.assign(this, t)),
        (this.type = e));
    }
  },
  Xe = class extends Z {
  ...
  Ze = class e extends Xe {
    ...
    constructor(t, n, r) {
      (super(t, n, r),
        ...
        (this.connectionId =
          this.options.connectionId || e.ID_PREFIX + I.randomToken()),
        (this._negotiator = new Je(this)),
        this._localStream &&
    ...
    _initializeDataChannel(e) {
      ((this.dataChannel = e),
        (this.dataChannel.onopen = () => {
          (L.log(`DC#${this.connectionId} dc connection success`),
            this.emit(`willCloseOnRemote`));
        }),
        (this.dataChannel.onclose = () => {
          (L.log(`DC#${this.connectionId} dc closed for:`, this.peer),
            this.close());
        }));
    }
    addStream(e) {
      (L.log(`Receiving stream`, e),
    ...
    handleMessage(e) {
      ...
      switch (e.type) {
        ...
        case X.Candidate:
          ...
          break;
        default:
          L.warn(`Unrecognized message type:${t} from peer:${this.peer}`);
          break;
      }
    }
    answer(e, t = {}) {
    ...
    close() {
      ((this._negotiator &&= (this._negotiator.cleanup(), null)),
        (this._localStream = null),
        (this._remoteStream = null),
        (this.provider &&= (this.provider._removeConnection(this), null)),
  ...
  Qe = class {
    ...
    _buildRequest(e) {
      let t = this._options.secure ? `https` : `http`,
        { host: n, port: r, path: i, key: a } = this._options,
        o = new URL(`${t}://${n}:${r}${i}${a}/${e}`);
      return (
        o.searchParams.set(`ts`, `${Date.now()}${Math.random()}`),
        o.searchParams.set(`version`, Ke),
        fetch(o.href, { referrerPolicy: this._options.referrerPolicy })
      );
    }
    async retrieveId() {
      try {
        ...
        L.error(`Error retrieving ID`, e);
        let t = ``;
        throw (
          this._options.path === `/` &&
            this._options.host !== I.CLOUD_HOST &&
            (t =
          ...
          Error(`Could not get an ID from the server.` + t)
        );
      }
    }
    async listAllPeers() {
      try {
        ...
        throw (
          L.error(`Error retrieving list peers`, e),
  ...
  $e = class e extends Xe {
    ...
    constructor(t, n, r) {
      (super(t, n, r),
        (this.connectionId = this.options.connectionId || e.ID_PREFIX + Be()),
    ...
    _initializeDataChannel(e) {
      ((this.dataChannel = e),
        ...
        (this.dataChannel.onmessage = (e) => {
          L.log(`DC#${this.connectionId} dc onmessage:`, e.data);
        }),
        (this.dataChannel.onclose = () => {
          (L.log(`DC#${this.connectionId} dc closed for:`, this.peer),
            this.close());
  ...
  Q = class extends $e {
    ...
    _trySend(e) {
      ...
      if (this.dataChannel.bufferedAmount > $e.MAX_BUFFERED_AMOUNT)
        return (
          (this._buffering = !0),
          setTimeout(() => {
      ...
      try {
        ...
        return (
          L.error(`DC#:${this.connectionId} Error when sending:`, e),
          (this._buffering = !0),
          this.close(),
          !1
        );
  ...
  $ = class extends Q {
    ...
    _sendChunks(e) {
      ...
      L.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);
  ...
  et = class extends Q {
    ...
    constructor(...e) {
      (super(...e), (this.serialization = J.None));
    }
  },
  tt = class extends Q {
    _handleDataMessage({ data: e }) {
    ...
    _send(e, t) {
      ...
      if (n.byteLength >= I.chunkedMTU) {
        this.emitError(q.MessageToBig, `Message too big for JSON channel`);
        return;
      }
      this._bufferedSend(n);
    }
  ...
  nt = class e extends Z {
      ...
      if (
        ...
        this._options.path &&
          ...
          this._options.path[this._options.path.length - 1] !== `/` &&
            (this._options.path += `/`)),
        this._options.secure === void 0 && this._options.host !== I.CLOUD_HOST
          ? (this._options.secure = I.isSecure())
          : this._options.host == I.CLOUD_HOST && (this._options.secure = !0),
        this._options.logFunction &&
          L.setLogFunction(this._options.logFunction),
        (L.logLevel = this._options.debug || 0),
        (this._api = new Qe(n)),
        (this._socket = this._createServerConnection()),
        !I.supports.audioVideo && !I.supports.data)
      ) {
        this._delayedAbort(
          G.BrowserIncompatible,
          `The current browser does not support WebRTC`,
        );
        return;
      }
      if (r && !I.validateId(r)) {
        this._delayedAbort(G.InvalidID, `ID "${r}" is invalid`);
        return;
      }
      r
        ? this._initialize(r)
        : this._api
            ...
            .catch((e) => this._abort(G.ServerError, e));
    }
    _createServerConnection() {
      ...
      return (
        ...
        e.on(Y.Error, (e) => {
          this._abort(G.SocketError, e);
        }),
        e.on(Y.Disconnected, () => {
          this.disconnected ||
            (this.emitError(G.Network, `Lost connection to server.`),
            this.disconnect());
        }),
        e.on(Y.Close, () => {
          this.disconnected ||
            this._abort(G.SocketClosed, `Underlying socket is already closed.`);
        }),
        e
      );
    }
    ...
    _handleMessage(e) {
      ...
      switch (t) {
        ...
        case X.InvalidKey:
          ...
          break;
        case X.Leave:
          (L.log(`Received leave message from ${r}`),
            this._cleanupPeer(r),
            this._connections.delete(r));
          break;
        case X.Expire:
          this.emitError(G.PeerUnavailable, `Could not connect to peer ${r}`);
          break;
        case X.Offer: {
          ...
          if (
            (t &&
              (t.close(),
              L.warn(`Offer received for existing Connection ID:${e}`)),
            n.type === W.Media)
          ) {
            let i = new Ze(r, this, {
              connectionId: e,
        ...
        default: {
          ...
          let i = n.connectionId,
            a = this.getConnection(r, i);
          a && a.peerConnection
            ? a.handleMessage(e)
            : i
              ? this._storeMessage(i, e)
              : L.warn(`You received an unrecognized message:`, e);
          break;
        }
      }
    }
    ...
    call(e, t, n = {}) {
      ...
      let r = new Ze(e, this, { ...n, _stream: t });
      return (this._addConnection(e, r), r);
    }
    _addConnection(e, t) {
      (L.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),
    ...
    destroy() {
      this.destroyed ||
        (L.log(`Destroy peer with ID:${this.id}`),
        this.disconnect(),
        this._cleanup(),
        (this._destroyed = !0),
        this.emit(`close`));
    ...
    disconnect() {
      ...
      let e = this.id;
      (L.log(`Disconnect peer with ID:${e}`),
        (this._disconnected = !0),
        (this._open = !1),
        this.socket.close(),
