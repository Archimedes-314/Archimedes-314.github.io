...
function g() {
  let [e, t] = (0, f.useState)(0),
    [n, r] = (0, f.useState)(() => {
      let e = localStorage.getItem(`roster_shifts`);
      return e ? JSON.parse(e) : [];
    }),
    [i, a] = (0, f.useState)(() => {
      let e = localStorage.getItem(`kanban_tasks`);
      return e
        ? JSON.parse(e)
        : [
            {
              id: `t1`,
              title: `Example: Set up medical appointments`,
              status: `todo`,
              priority: `high`,
            },
            {
              id: `t2`,
              title: `Example: Meal prep for the week`,
              status: `in-progress`,
              priority: `medium`,
            },
          ];
    ...
    u = (e) => {
      (r(e), localStorage.setItem(`roster_shifts`, JSON.stringify(e)));
    },
    d = (e) => {
      (a(e), localStorage.setItem(`kanban_tasks`, JSON.stringify(e)));
    },
    g = () => {
      let e = {
          version: `1.0`,
      ...
      (r.setAttribute(`href`, t),
        r.setAttribute(
          `download`,
          `task_tracker_backup_${new Date().toISOString().split(`T`)[0]}.json`,
        ),
      ...
      n &&
        ((t.onload = (e) => {
          try {
            ...
            t && Array.isArray(t.shifts) && Array.isArray(t.tasks)
              ? window.confirm(
                  `Are you sure you want to import this data? It will replace your current tasks and roster slots.`,
                ) &&
                (u(t.shifts), d(t.tasks), alert(`Data imported successfully!`))
              : alert(`Invalid backup file format. Could not restore data.`);
          } catch (e) {
            (alert(
              `Error reading file. Make sure it's a valid JSON data backup.`,
            ),
              console.error(e));
          }
        }),
    ...
    v = (e) => {
      if ((e.preventDefault(), !o.trim())) return;
      let t = {
        id: `task_` + Date.now(),
        title: o.trim(),
        status: `todo`,
    ...
    y = (e, t) => {
      d(i.map((n) => (n.id === e ? { ...n, status: t } : n)));
    },
    b = (e, t) => {
      d(i.map((n) => (n.id === e ? { ...n, priority: t } : n)));
    },
    x = (e) => {
      d(i.filter((t) => t.id !== e));
    },
    ee = (e) => {
      if ((e.preventDefault(), !c.title.trim())) return;
      let t = { id: `shift_` + Date.now(), ...c, title: c.title.trim() };
      (u([...n, t]), l({ ...c, title: `` }));
    },
    S = (e) => {
      u(n.filter((t) => t.id !== e));
    ...
    C = (e, t) => {
      (l((n) => ({ ...n, title: e, priority: t || `medium` })),
    ...
    w = (e, t) => {
      e.preventDefault();
      try {
        let r = JSON.parse(e.dataTransfer.getData(`text/plain`)),
          i = {
            id: `shift_` + Date.now(),
            title: r.title,
            date: t,
        ...
        console.error(`Failed drop calculation`, e);
      }
    },
    ie = (e, t) => {
      e.preventDefault();
      try {
        let n = JSON.parse(e.dataTransfer.getData(`text/plain`));
        n.id && n.status && y(n.id, t);
      } catch (e) {
    ...
    ae = h(m(e)),
    oe = {
      low: { border: `#2e7d32`, bg: `#edf7ed`, text: `#1b5e20` },
      medium: { border: `#ed6c02`, bg: `#fff8e1`, text: `#e65100` },
      high: { border: `#d32f2f`, bg: `#fdeeed`, text: `#b71c1c` },
    },
    se = (e) => {
      let t = { low: 0, medium: 0, high: 0 };
      return (
        e.forEach((e) => {
          t[e.priority] !== void 0 && t[e.priority]++;
        }),
        t
      );
    };
          ...
          children: [
                      ...
                      children: [
                        (0, p.jsx)(`button`, {
                          ...
                          style: {
                            ...
                            borderRadius: `6px`,
                            border: `none`,
                            backgroundColor: e === 0 ? `#fff` : `transparent`,
                            color: e === 0 ? `#1a1a1a` : `#666`,
                            boxShadow:
                              e === 0 ? `0 2px 4px rgba(0,0,0,0.08)` : `none`,
                            cursor: `pointer`,
                            fontSize: `13px`,
                          },
                        ...
                        (0, p.jsx)(`button`, {
                          ...
                          style: {
                            ...
                            borderRadius: `6px`,
                            border: `none`,
                            backgroundColor: e === 1 ? `#fff` : `transparent`,
                            color: e === 1 ? `#1a1a1a` : `#666`,
                            boxShadow:
                              e === 1 ? `0 2px 4px rgba(0,0,0,0.08)` : `none`,
                            cursor: `pointer`,
                            fontSize: `13px`,
                          },
                          children: `Next Week`,
            ...
            (0, p.jsxs)(`form`, {
              ...
              children: [
                (0, p.jsx)(`input`, {
                  type: `text`,
                  placeholder: `Task/Shift Title`,
                  value: c.title,
                  onChange: (e) => l({ ...c, title: e.target.value }),
                  style: {
                    padding: `10px 12px`,
                    flex: `2 1 200px`,
                    borderRadius: `6px`,
                ...
                (0, p.jsx)(`input`, {
                  type: `date`,
                  value: c.date,
                  onChange: (e) => l({ ...c, date: e.target.value }),
                  style: {
                    padding: `10px 12px`,
                    borderRadius: `6px`,
                    border: `1px solid #ccc`,
                ...
                (0, p.jsxs)(`div`, {
                  ...
                  children: [
                    (0, p.jsx)(`input`, {
                      type: `time`,
                      value: c.startTime,
                      onChange: (e) => l({ ...c, startTime: e.target.value }),
                      style: {
                        padding: `10px 8px`,
                        borderRadius: `6px`,
                        border: `1px solid #ccc`,
                    ...
                    (0, p.jsx)(`input`, {
                      type: `time`,
                      value: c.endTime,
                      onChange: (e) => l({ ...c, endTime: e.target.value }),
                      style: {
                        padding: `10px 8px`,
                        borderRadius: `6px`,
                        border: `1px solid #ccc`,
                ...
                (0, p.jsxs)(`select`, {
                  value: c.priority,
                  onChange: (e) => l({ ...c, priority: e.target.value }),
                  style: {
                    padding: `10px 12px`,
                    borderRadius: `6px`,
                    border: `1px solid #ccc`,
              ...
              children: ae.map((e) => {
                ...
                return (0, p.jsxs)(
                  `div`,
                  {
                    ...
                    onDrop: (e) => w(e, t),
                    style: {
                      border: r ? `2px solid #0288d1` : `1px solid #e0e0e0`,
                      borderRadius: `10px`,
                      padding: `14px`,
                      background: r ? `#f4fafd` : `#ffffff`,
                      minHeight: `340px`,
                      display: `flex`,
                          ...
                          (0, p.jsxs)(
                            `div`,
                            {
                              style: {
                                ...
                                borderRadius: `6px`,
                                backgroundColor:
                                  oe[e.priority]?.bg || `#fafafa`,
                                borderLeft: `4px solid ${oe[e.priority]?.border || `#ccc`}`,
        ...
        (0, p.jsxs)(`div`, {
          ...
          children: [
            (0, p.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, p.jsx)(`p`, {
                  ...
                  children: `Drag cards across columns to sort, or onto days above to pin them directly.`,
                }),
                (0, p.jsxs)(`form`, {
                  onSubmit: v,
                  ...
                  children: [
                    (0, p.jsx)(`input`, {
                      type: `text`,
                      placeholder: `Add task to master list...`,
                      value: o,
            ...
            (0, p.jsx)(`div`, {
              ...
              children: [`todo`, `in-progress`, `done`].map((e) => {
                let t = i.filter((t) => t.status === e);
                return (0, p.jsxs)(
                  `div`,
                  {
                    onDragOver: re,
                      ...
                      (0, p.jsx)(`div`, {
                        ...
                        children: t.map((t) =>
                          (0, p.jsxs)(
                            ...
                            {
                              draggable: !0,
                              onDragStart: (e) => ne(e, t),
                              style: {
                                background: `#fff`,
                                padding: `12px`,
                                borderRadius: `6px`,
                                borderLeft: `5px solid ${oe[t.priority]?.border || `#ccc`}`,
                                backgroundColor:
                                  t.status === `done` ? `#fdfdfd` : `#fff`,
...
function _() {
  return (0, p.jsx)(`div`, { className: `App`, children: (0, p.jsx)(g, {}) });
}
((0, d.createRoot)(document.getElementById(`root`)).render(
  (0, p.jsx)(f.StrictMode, { children: (0, p.jsx)(_, {}) }),
),
  `serviceWorker` in navigator &&
    window.addEventListener(`load`, () => {
      navigator.serviceWorker
        .register(`/extras/task-tracker/service-worker.js`, {
          scope: `/extras/task-tracker/`,
        })
        .then((e) =>
