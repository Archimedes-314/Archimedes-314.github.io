...
function p() {
  let [e, t] = (0, l.useState)(() => {
      let e = localStorage.getItem(`saved_kanban`);
      return e
        ? JSON.parse(e)
        : [
    ...
    b = (0, l.useRef)(null);
  (0, l.useEffect)(() => {
    localStorage.setItem(`saved_kanban`, JSON.stringify(e));
  }, [e]);
  let x = n
      ? e.find((e) => e.id === i)?.tasks.find((e) => e.id === n.id)
      : null,
    ee = () => {
      try {
        ...
        (r.setAttribute(`href`, n),
          r.setAttribute(`download`, `kanban_board_backup.json`),
          r.click());
      } catch {
      ...
      i &&
        ((n.onload = (n) => {
          try {
            ...
            Array.isArray(e)
              ? window.confirm(
                  `Importing will overwrite your current board. Proceed?`,
                ) && (t(e), r(null), alert(`Data imported successfully!`))
    ...
    C = (r, i, o) => {
      ...
      let s = null,
        c = e.map((e) =>
          e.id === i
            ? ((s = e.tasks.find((e) => e.id === r)),
              { ...e, tasks: e.tasks.filter((e) => e.id !== r) })
            : e,
        );
      s &&
        (t(c.map((e) => (e.id === o ? { ...e, tasks: [...e.tasks, s] } : e))),
        n && n.id === r && a(o));
    },
    te = (e, t) => {
      (_(t), y(e));
    ...
    re = (e) => {
      !g || !v || (C(g, v, e), _(null), y(null));
    },
    w = (n) => {
      if ((n.preventDefault(), !m.trim())) return;
      let r = { id: `col_` + Date.now(), name: m.trim(), tasks: [] };
      (t([...e, r]), h(``));
    },
    ie = (n) => {
      window.confirm(
        `Are you sure you want to delete this column and all its items?`,
      ) && (t(e.filter((e) => e.id !== n)), i === n && (r(null), a(null)));
    },
    ae = (n, r) => {
      if ((r.preventDefault(), !o.trim())) return;
      let i = { id: Date.now(), text: o.trim(), priority: c, subtasks: [] };
      (t(e.map((e) => (e.id === n ? { ...e, tasks: [...e.tasks, i] } : e))),
        oe());
    },
    oe = () => {
      (s(``), u(`Medium`));
      ...
      (s && s.stopPropagation(),
        window.confirm(`Delete this task?`) &&
          (t(
            e.map((e) =>
              e.id === i
                ? { ...e, tasks: e.tasks.filter((e) => e.id !== o) }
                : e,
            ),
          ),
          n?.id === o && (r(null), a(null))));
    },
    ce = (n, r, i) => {
      t(
        e.map((e) =>
                    ...
                    tasks: e.tasks.map((e) =>
                      e.id === n.id
                        ? {
                            ...
                            subtasks: [
                              ...e.subtasks,
                              { id: Date.now(), text: d.trim(), done: !1 },
                            ],
                          }
                        : e,
                    ),
        ...
        e.map((e) =>
          e.id === i
            ? {
                ...
                tasks: e.tasks.map((e) =>
                  e.id === n.id
                    ? { ...e, subtasks: e.subtasks.filter((e) => e.id !== r) }
                    : e,
                ),
              }
            : e,
    ...
    children: [
      ...
      (0, f.jsx)(`header`, {
        ...
        children: (0, f.jsxs)(`div`, {
          className: `max-w-7xl mx-auto px-4 min-h-16 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4`,
          children: [
            (0, f.jsxs)(`div`, {
              className: `flex flex-wrap items-center justify-between sm:justify-start gap-4`,
              children: [
                (0, f.jsx)(`h1`, {
                  className: `text-xl font-bold tracking-wide text-indigo-400`,
                  children: `Workspace Kanban`,
                }),
                (0, f.jsxs)(`div`, {
                  ...
                  children: [
                    (0, f.jsx)(`button`, {
                      onClick: ee,
                      className: `px-2.5 py-1.5 text-xs bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-md transition`,
                      children: `📤 Export`,
                    }),
                    (0, f.jsx)(`button`, {
            ...
            (0, f.jsxs)(`form`, {
              ...
              children: [
                (0, f.jsx)(`input`, {
                  ...
                  className: `flex-1 sm:flex-initial bg-slate-800 border border-slate-700 rounded-lg px-3 py-1 text-xs focus:outline-none focus:border-indigo-500`,
                }),
                (0, f.jsx)(`button`, {
                  type: `submit`,
                  className: `bg-indigo-600 hover:bg-indigo-500 px-3 py-1.5 text-xs rounded-lg font-bold shrink-0`,
                  children: `+ Col`,
                }),
              ],
            }),
      ...
      (0, f.jsx)(`main`, {
        className: `max-w-7xl mx-auto px-4 py-6 overflow-x-auto`,
        children: (0, f.jsx)(`div`, {
          className: `flex items-start gap-5 min-h-[75vh]`,
          children: e.map((t) =>
            (0, f.jsxs)(
              `div`,
              {
                onDragOver: ne,
                onDrop: () => re(t.id),
                className: `w-80 shrink-0 border border-slate-800 rounded-2xl p-4 flex flex-col bg-slate-950/30`,
                children: [
                  (0, f.jsxs)(`div`, {
                    className: `flex justify-between items-center mb-4`,
                    children: [
                      (0, f.jsxs)(`h3`, {
                        className: `font-bold text-slate-300 tracking-wide text-sm uppercase flex items-center gap-2`,
                        children: [
                          (0, f.jsx)(`span`, { children: t.name }),
                          (0, f.jsx)(`span`, {
                            className: `text-xs bg-slate-800 text-slate-400 px-2 py-0.5 rounded-full`,
                            children: t.tasks.length,
                          }),
                        ],
                      }),
                      (0, f.jsx)(`button`, {
                  ...
                  (0, f.jsxs)(`form`, {
                    onSubmit: (e) => ae(t.id, e),
                    className: `bg-slate-800/40 p-2 border border-slate-800 rounded-xl mb-4 space-y-2`,
                    children: [
                      (0, f.jsx)(`input`, {
                        type: `text`,
                        ...
                        className: `w-full bg-slate-800 border border-slate-700 rounded-lg px-2.5 py-1.5 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-indigo-500`,
                      }),
                      (0, f.jsxs)(`div`, {
                        ...
                        children: [
                          (0, f.jsxs)(`select`, {
                            ...
                            className: `bg-slate-800 text-[11px] border border-slate-700 rounded-md px-1.5 py-1 text-slate-300 outline-none`,
                            children: [
                              (0, f.jsx)(`option`, {
                                value: `Low`,
                          ...
                          (0, f.jsx)(`button`, {
                            type: `submit`,
                            className: `bg-indigo-600 hover:bg-indigo-500 text-white text-[11px] font-bold px-3 py-1 rounded-md`,
                            children: `Add Task`,
                          }),
                        ],
                      }),
                  ...
                  (0, f.jsx)(`div`, {
                    className: `space-y-2.5 overflow-y-auto max-h-[60vh] pr-1`,
                    children: t.tasks.map((n) => {
                      let i = n.subtasks?.filter((e) => e.done).length || 0,
                        o = n.subtasks?.length || 0;
                      return (0, f.jsxs)(
                        `div`,
                        {
                          draggable: !0,
                          onDragStart: () => te(t.id, n.id),
                          onClick: () => {
                            (r(n), a(t.id));
                          },
                          className: `bg-slate-800 hover:bg-slate-750 border border-slate-700/60 rounded-xl p-3 shadow-md cursor-grab active:cursor-grabbing transition duration-150 relative group ${g === n.id ? `opacity-30 border-indigo-500 scale-[0.97]` : ``}`,
                          children: [
                            (0, f.jsxs)(`div`, {
                              className: `flex justify-between items-center gap-2 mb-2`,
                              children: [
                                (0, f.jsx)(`span`, {
                                  className: `text-[9px] uppercase tracking-wider font-bold px-2 py-0.5 border rounded-md ${E(n.priority)}`,
                                  children: n.priority,
                                }),
                                (0, f.jsx)(`button`, {
                                  onClick: (e) => se(t.id, n.id, e),
                                  className: `opacity-0 group-hover:opacity-100 text-slate-500 hover:text-rose-400 text-xs transition px-1`,
                                  children: `✕`,
                                }),
                              ],
                            }),
                            (0, f.jsx)(`h4`, {
                              className: `font-semibold text-sm text-slate-200 line-clamp-2 leading-snug mb-3`,
                              children: n.text,
                            }),
                            (0, f.jsxs)(`div`, {
                              className: `mt-2`,
                              ...
                              children: [
                                (0, f.jsx)(`label`, {
                                  className: `text-[10px] text-slate-500 block mb-0.5`,
                                  children: `Move Column:`,
                                }),
                                (0, f.jsx)(`select`, {
                                  value: t.id,
                                  onChange: (e) =>
                                    C(n.id, t.id, e.target.value),
                                  className: `w-full bg-slate-900 border border-slate-700 rounded-md text-[11px] py-1 px-1.5 text-slate-300 outline-none focus:border-indigo-500`,
                                  children: e.map((e) =>
                                    (0, f.jsx)(
                                      `option`,
                            ...
                            o > 0 &&
                              (0, f.jsxs)(`div`, {
                                className: `mt-3 pt-2 border-t border-slate-700/40 flex items-center justify-between text-[11px] text-slate-400`,
                                children: [
                                  (0, f.jsxs)(`span`, {
                                  ...
                                  (0, f.jsx)(`div`, {
                                    className: `w-20 bg-slate-700 h-1 rounded-full overflow-hidden`,
                                    children: (0, f.jsx)(`div`, {
      ...
      x &&
        (0, f.jsx)(`div`, {
          ...
          children: (0, f.jsxs)(`div`, {
            className: `bg-slate-850 border border-slate-700 rounded-2xl w-full max-w-md p-6 shadow-2xl`,
            children: [
              (0, f.jsxs)(`div`, {
                className: `flex items-start justify-between gap-4 mb-4 pb-3 border-b border-slate-800`,
                children: [
                  (0, f.jsxs)(`div`, {
                    ...
                    children: [
                      (0, f.jsxs)(`div`, {
                        ...
                        children: [
                          (0, f.jsx)(`span`, {
                            className: `text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 border rounded-md ${E(x.priority)}`,
                            children: x.priority,
                          }),
                          (0, f.jsx)(`div`, {
                            ...
                            children: (0, f.jsxs)(`select`, {
                              value: x.priority,
                              onChange: (e) => ce(i, x.id, e.target.value),
                              className: `bg-slate-800 text-[11px] border border-slate-700 rounded-md py-0.5 px-1.5 text-slate-300 outline-none focus:border-indigo-500`,
                              children: [
                                (0, f.jsx)(`option`, {
                                  value: `Low`,
                                  children: `Low`,
                      ...
                      (0, f.jsx)(`h2`, {
                        className: `text-lg font-bold text-slate-100 break-words leading-tight`,
                        children: x.text,
                      }),
                    ],
                  }),
                  (0, f.jsxs)(`div`, {
                    ...
                    children: [
                      (0, f.jsx)(`button`, {
                        onClick: () => se(i, x.id),
                        className: `text-slate-500 hover:text-rose-400 text-xs bg-slate-800/60 p-1.5 rounded-lg border border-slate-700/50 transition`,
                      ...
                      (0, f.jsx)(`button`, {
                        ...
                        className: `text-slate-400 hover:text-slate-100 font-bold bg-slate-800/60 px-2 py-1 rounded-lg border border-slate-700/50 transition text-xs`,
                        children: `✕`,
                      }),
                    ],
                  }),
              ...
              (0, f.jsxs)(`form`, {
                ...
                children: [
                  (0, f.jsx)(`input`, {
                    ...
                    className: `flex-1 bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-sm text-slate-100 focus:outline-none focus:border-indigo-500`,
                  }),
                  (0, f.jsx)(`button`, {
                    type: `submit`,
                    className: `bg-indigo-600 hover:bg-indigo-500 text-white font-bold px-4 rounded-xl text-xs`,
                    children: `Add`,
                  }),
                ],
              }),
                  ...
                  x.subtasks.length === 0
                    ...
                    : x.subtasks.map((e) =>
                        (0, f.jsxs)(
                          ...
                          {
                            onClick: () => ue(e.id),
                            className: `flex justify-between items-center p-2.5 border rounded-xl cursor-pointer select-none transition ${e.done ? `bg-emerald-950/20 border-emerald-500/30 text-slate-500 line-through` : `bg-slate-800 border-slate-700`}`,
                            children: [
                              (0, f.jsxs)(`div`, {
                                className: `flex items-center gap-3 overflow-hidden`,
                                children: [
                                  (0, f.jsx)(`div`, {
                                    className: `w-4 h-4 rounded border flex items-center justify-center text-[10px] ${e.done ? `bg-emerald-600 border-emerald-500 text-white` : `border-slate-500`}`,
                                    children: e.done && `✓`,
                                  }),
                                  (0, f.jsx)(`span`, {
                              ...
                              (0, f.jsx)(`button`, {
                                ...
                                className: `text-slate-500 hover:text-rose-400 text-xs transition px-1`,
                                children: `✕`,
                              }),
                            ],
                          },
