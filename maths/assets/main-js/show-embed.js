document.addEventListener("DOMContentLoaded", () => {
  ...
  const COMPLETE_PDF = `/maths/assets/pdf/files/${sectionKey}-section.pdf`;
  const FULL_PDF = `/maths/assets/pdf/files/${webpageKey}-webpage.pdf`;
  const SIMPLE_PDF = `/maths/assets/pdf/files/${webpageKey}-simple.pdf`;
